...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4cc:	33070713          	addi	a4,a4,816 # 7f8 <malloc+0xf8>
 ...
 556:	2feb8b93          	addi	s7,s7,766 # 850 <digits>
 ...
 5aa:	24a90913          	addi	s2,s2,586 # 7f0 <malloc+0xf0>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7da:	b62080e7          	jalr	-1182(ra) # 338 <sbrk>
  if(p == (char*)-1)
