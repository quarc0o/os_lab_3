...
main(int argc, char *argv[])
{
  ...
  34:	820a8a93          	addi	s5,s5,-2016 # 850 <malloc+0xec>
  ...
  76:	7e658593          	addi	a1,a1,2022 # 858 <malloc+0xf4>
  7a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42c:	49850513          	addi	a0,a0,1176 # 8c0 <digits>
 430:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 530:	33c70713          	addi	a4,a4,828 # 868 <malloc+0x104>
 ...
 5ba:	30ab8b93          	addi	s7,s7,778 # 8c0 <digits>
 ...
 60e:	25690913          	addi	s2,s2,598 # 860 <malloc+0xfc>
        while(*s != 0){
