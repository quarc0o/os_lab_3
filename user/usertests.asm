...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	09250513          	addi	a0,a0,146 # 60d0 <malloc+0xf2>
      46:	00006097          	auipc	ra,0x6
      4a:	ee0080e7          	jalr	-288(ra) # 5f26 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	07050513          	addi	a0,a0,112 # 60f0 <malloc+0x112>
      88:	00006097          	auipc	ra,0x6
      8c:	e9e080e7          	jalr	-354(ra) # 5f26 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	06050513          	addi	a0,a0,96 # 6108 <malloc+0x12a>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	06250513          	addi	a0,a0,98 # 6128 <malloc+0x14a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	02a50513          	addi	a0,a0,42 # 6110 <malloc+0x132>
      ee:	00006097          	auipc	ra,0x6
      f2:	e38080e7          	jalr	-456(ra) # 5f26 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	03650513          	addi	a0,a0,54 # 6138 <malloc+0x15a>
     10a:	00006097          	auipc	ra,0x6
     10e:	e1c080e7          	jalr	-484(ra) # 5f26 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	03450513          	addi	a0,a0,52 # 6160 <malloc+0x182>
     134:	00006097          	auipc	ra,0x6
     138:	aaa080e7          	jalr	-1366(ra) # 5bde <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	02050513          	addi	a0,a0,32 # 6160 <malloc+0x182>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	01c58593          	addi	a1,a1,28 # 6170 <malloc+0x192>
     15c:	00006097          	auipc	ra,0x6
     160:	a52080e7          	jalr	-1454(ra) # 5bae <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ff850513          	addi	a0,a0,-8 # 6160 <malloc+0x182>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	ffc58593          	addi	a1,a1,-4 # 6178 <malloc+0x19a>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fcc50513          	addi	a0,a0,-52 # 6160 <malloc+0x182>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fb650513          	addi	a0,a0,-74 # 6180 <malloc+0x1a2>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	d54080e7          	jalr	-684(ra) # 5f26 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f2c50513          	addi	a0,a0,-212 # 61a8 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f18a8a93          	addi	s5,s5,-232 # 61a8 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ea650513          	addi	a0,a0,-346 # 61b8 <malloc+0x1da>
     31a:	00006097          	auipc	ra,0x6
     31e:	c0c080e7          	jalr	-1012(ra) # 5f26 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	ea450513          	addi	a0,a0,-348 # 61d8 <malloc+0x1fa>
     33c:	00006097          	auipc	ra,0x6
     340:	bea080e7          	jalr	-1046(ra) # 5f26 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	e9250513          	addi	a0,a0,-366 # 61f0 <malloc+0x212>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	e7e98993          	addi	s3,s3,-386 # 61f0 <malloc+0x212>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e3250513          	addi	a0,a0,-462 # 61f0 <malloc+0x212>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	da258593          	addi	a1,a1,-606 # 6178 <malloc+0x19a>
    ...
    printf("write failed\n");
     ...
     3f0:	e2450513          	addi	a0,a0,-476 # 6210 <malloc+0x232>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b32080e7          	jalr	-1230(ra) # 5f26 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	df250513          	addi	a0,a0,-526 # 61f8 <malloc+0x21a>
     40e:	00006097          	auipc	ra,0x6
     412:	b18080e7          	jalr	-1256(ra) # 5f26 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	dd850513          	addi	a0,a0,-552 # 61f8 <malloc+0x21a>
     428:	00006097          	auipc	ra,0x6
     42c:	afe080e7          	jalr	-1282(ra) # 5f26 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	dac50513          	addi	a0,a0,-596 # 61f0 <malloc+0x212>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	cd0a0a13          	addi	s4,s4,-816 # 6220 <malloc+0x242>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c2c50513          	addi	a0,a0,-980 # 6228 <malloc+0x24a>
     604:	00006097          	auipc	ra,0x6
     608:	922080e7          	jalr	-1758(ra) # 5f26 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c2650513          	addi	a0,a0,-986 # 6240 <malloc+0x262>
     622:	00006097          	auipc	ra,0x6
     626:	904080e7          	jalr	-1788(ra) # 5f26 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c3850513          	addi	a0,a0,-968 # 6270 <malloc+0x292>
     640:	00006097          	auipc	ra,0x6
     644:	8e6080e7          	jalr	-1818(ra) # 5f26 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c4e50513          	addi	a0,a0,-946 # 62a0 <malloc+0x2c2>
     65a:	00006097          	auipc	ra,0x6
     65e:	8cc080e7          	jalr	-1844(ra) # 5f26 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c4050513          	addi	a0,a0,-960 # 62b0 <malloc+0x2d2>
     678:	00006097          	auipc	ra,0x6
     67c:	8ae080e7          	jalr	-1874(ra) # 5f26 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c32a0a13          	addi	s4,s4,-974 # 62e0 <malloc+0x302>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	ac2a8a93          	addi	s5,s5,-1342 # 6178 <malloc+0x19a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	b8c50513          	addi	a0,a0,-1140 # 62e8 <malloc+0x30a>
     764:	00005097          	auipc	ra,0x5
     768:	7c2080e7          	jalr	1986(ra) # 5f26 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	b8650513          	addi	a0,a0,-1146 # 6300 <malloc+0x322>
     782:	00005097          	auipc	ra,0x5
     786:	7a4080e7          	jalr	1956(ra) # 5f26 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b0c50513          	addi	a0,a0,-1268 # 62a0 <malloc+0x2c2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	78a080e7          	jalr	1930(ra) # 5f26 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	b8250513          	addi	a0,a0,-1150 # 6330 <malloc+0x352>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	770080e7          	jalr	1904(ra) # 5f26 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	b7c50513          	addi	a0,a0,-1156 # 6348 <malloc+0x36a>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	752080e7          	jalr	1874(ra) # 5f26 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	94e58593          	addi	a1,a1,-1714 # 6170 <malloc+0x192>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	92250513          	addi	a0,a0,-1758 # 6160 <malloc+0x182>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	8f650513          	addi	a0,a0,-1802 # 6160 <malloc+0x182>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	8e250513          	addi	a0,a0,-1822 # 6160 <malloc+0x182>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b1c58593          	addi	a1,a1,-1252 # 63d8 <malloc+0x3fa>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	86250513          	addi	a0,a0,-1950 # 6160 <malloc+0x182>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a3650513          	addi	a0,a0,-1482 # 6378 <malloc+0x39a>
     94a:	00005097          	auipc	ra,0x5
     94e:	5dc080e7          	jalr	1500(ra) # 5f26 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a3a50513          	addi	a0,a0,-1478 # 6398 <malloc+0x3ba>
     966:	00005097          	auipc	ra,0x5
     96a:	5c0080e7          	jalr	1472(ra) # 5f26 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a3650513          	addi	a0,a0,-1482 # 63a8 <malloc+0x3ca>
     97a:	00005097          	auipc	ra,0x5
     97e:	5ac080e7          	jalr	1452(ra) # 5f26 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a3a50513          	addi	a0,a0,-1478 # 63c8 <malloc+0x3ea>
     996:	00005097          	auipc	ra,0x5
     99a:	590080e7          	jalr	1424(ra) # 5f26 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a0650513          	addi	a0,a0,-1530 # 63a8 <malloc+0x3ca>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	57c080e7          	jalr	1404(ra) # 5f26 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a2050513          	addi	a0,a0,-1504 # 63e0 <malloc+0x402>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	55e080e7          	jalr	1374(ra) # 5f26 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a2250513          	addi	a0,a0,-1502 # 6400 <malloc+0x422>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	540080e7          	jalr	1344(ra) # 5f26 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a0e50513          	addi	a0,a0,-1522 # 6420 <malloc+0x442>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a1e98993          	addi	s3,s3,-1506 # 6448 <malloc+0x46a>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a4ea8a93          	addi	s5,s5,-1458 # 6480 <malloc+0x4a2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9a850513          	addi	a0,a0,-1624 # 6420 <malloc+0x442>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	96c50513          	addi	a0,a0,-1684 # 6420 <malloc+0x442>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	94a50513          	addi	a0,a0,-1718 # 6428 <malloc+0x44a>
     ae6:	00005097          	auipc	ra,0x5
     aea:	440080e7          	jalr	1088(ra) # 5f26 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	95c50513          	addi	a0,a0,-1700 # 6458 <malloc+0x47a>
     b04:	00005097          	auipc	ra,0x5
     b08:	422080e7          	jalr	1058(ra) # 5f26 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	97650513          	addi	a0,a0,-1674 # 6490 <malloc+0x4b2>
     b22:	00005097          	auipc	ra,0x5
     b26:	404080e7          	jalr	1028(ra) # 5f26 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	98250513          	addi	a0,a0,-1662 # 64b8 <malloc+0x4da>
     b3e:	00005097          	auipc	ra,0x5
     b42:	3e8080e7          	jalr	1000(ra) # 5f26 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	98650513          	addi	a0,a0,-1658 # 64d8 <malloc+0x4fa>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	3cc080e7          	jalr	972(ra) # 5f26 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	98250513          	addi	a0,a0,-1662 # 64f0 <malloc+0x512>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3b0080e7          	jalr	944(ra) # 5f26 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	97050513          	addi	a0,a0,-1680 # 6510 <malloc+0x532>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	91e50513          	addi	a0,a0,-1762 # 6510 <malloc+0x532>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	8de50513          	addi	a0,a0,-1826 # 6518 <malloc+0x53a>
     c42:	00005097          	auipc	ra,0x5
     c46:	2e4080e7          	jalr	740(ra) # 5f26 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	8e050513          	addi	a0,a0,-1824 # 6538 <malloc+0x55a>
     c60:	00005097          	auipc	ra,0x5
     c64:	2c6080e7          	jalr	710(ra) # 5f26 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	8ec50513          	addi	a0,a0,-1812 # 6560 <malloc+0x582>
     c7c:	00005097          	auipc	ra,0x5
     c80:	2aa080e7          	jalr	682(ra) # 5f26 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	87050513          	addi	a0,a0,-1936 # 6510 <malloc+0x532>
     ...
     cd0:	8b450513          	addi	a0,a0,-1868 # 6580 <malloc+0x5a2>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	252080e7          	jalr	594(ra) # 5f26 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	8be50513          	addi	a0,a0,-1858 # 65a8 <malloc+0x5ca>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	234080e7          	jalr	564(ra) # 5f26 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	8b850513          	addi	a0,a0,-1864 # 65c0 <malloc+0x5e2>
     d10:	00005097          	auipc	ra,0x5
     d14:	216080e7          	jalr	534(ra) # 5f26 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	8c450513          	addi	a0,a0,-1852 # 65e8 <malloc+0x60a>
     d2c:	00005097          	auipc	ra,0x5
     d30:	1fa080e7          	jalr	506(ra) # 5f26 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8ae50513          	addi	a0,a0,-1874 # 6600 <malloc+0x622>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	8c658593          	addi	a1,a1,-1850 # 6630 <malloc+0x652>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	87a50513          	addi	a0,a0,-1926 # 6600 <malloc+0x622>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	86450513          	addi	a0,a0,-1948 # 6600 <malloc+0x622>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	84e50513          	addi	a0,a0,-1970 # 6600 <malloc+0x622>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8b258593          	addi	a1,a1,-1870 # 6678 <malloc+0x69a>
  ...
  unlink("unlinkread");
     ...
     e32:	7d250513          	addi	a0,a0,2002 # 6600 <malloc+0x622>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	7c250513          	addi	a0,a0,1986 # 6610 <malloc+0x632>
     e56:	00005097          	auipc	ra,0x5
     e5a:	0d0080e7          	jalr	208(ra) # 5f26 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	7ce50513          	addi	a0,a0,1998 # 6638 <malloc+0x65a>
     e72:	00005097          	auipc	ra,0x5
     e76:	0b4080e7          	jalr	180(ra) # 5f26 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	7d250513          	addi	a0,a0,2002 # 6658 <malloc+0x67a>
     e8e:	00005097          	auipc	ra,0x5
     e92:	098080e7          	jalr	152(ra) # 5f26 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	7de50513          	addi	a0,a0,2014 # 6680 <malloc+0x6a2>
     eaa:	00005097          	auipc	ra,0x5
     eae:	07c080e7          	jalr	124(ra) # 5f26 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	7e250513          	addi	a0,a0,2018 # 66a0 <malloc+0x6c2>
     ec6:	00005097          	auipc	ra,0x5
     eca:	060080e7          	jalr	96(ra) # 5f26 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	7e650513          	addi	a0,a0,2022 # 66c0 <malloc+0x6e2>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	044080e7          	jalr	68(ra) # 5f26 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	6f258593          	addi	a1,a1,1778 # 6630 <malloc+0x652>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	78a58593          	addi	a1,a1,1930 # 66e8 <malloc+0x70a>
     f66:	00005517          	auipc	a0,0x5
     f6a:	77a50513          	addi	a0,a0,1914 # 66e0 <malloc+0x702>
  ...
  unlink("lf1");
     ...
     f7e:	76650513          	addi	a0,a0,1894 # 66e0 <malloc+0x702>
     f82:	00005097          	auipc	ra,0x5
     f86:	c5c080e7          	jalr	-932(ra) # 5bde <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	75450513          	addi	a0,a0,1876 # 66e0 <malloc+0x702>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	74650513          	addi	a0,a0,1862 # 66e8 <malloc+0x70a>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	70e58593          	addi	a1,a1,1806 # 66e8 <malloc+0x70a>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	6f850513          	addi	a0,a0,1784 # 66e8 <malloc+0x70a>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	be6080e7          	jalr	-1050(ra) # 5bde <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	6e058593          	addi	a1,a1,1760 # 66e0 <malloc+0x702>
    1008:	00005517          	auipc	a0,0x5
    100c:	6e050513          	addi	a0,a0,1760 # 66e8 <malloc+0x70a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	6c458593          	addi	a1,a1,1732 # 66e0 <malloc+0x702>
    1024:	00005517          	auipc	a0,0x5
    1028:	7cc50513          	addi	a0,a0,1996 # 67f0 <malloc+0x812>
    ...
    104a:	6aa50513          	addi	a0,a0,1706 # 66f0 <malloc+0x712>
    104e:	00005097          	auipc	ra,0x5
    1052:	ed8080e7          	jalr	-296(ra) # 5f26 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	6a650513          	addi	a0,a0,1702 # 6708 <malloc+0x72a>
    106a:	00005097          	auipc	ra,0x5
    106e:	ebc080e7          	jalr	-324(ra) # 5f26 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	6a250513          	addi	a0,a0,1698 # 6720 <malloc+0x742>
    1086:	00005097          	auipc	ra,0x5
    108a:	ea0080e7          	jalr	-352(ra) # 5f26 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	6a650513          	addi	a0,a0,1702 # 6740 <malloc+0x762>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	e84080e7          	jalr	-380(ra) # 5f26 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	6ba50513          	addi	a0,a0,1722 # 6770 <malloc+0x792>
    10be:	00005097          	auipc	ra,0x5
    10c2:	e68080e7          	jalr	-408(ra) # 5f26 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	6b650513          	addi	a0,a0,1718 # 6788 <malloc+0x7aa>
    10da:	00005097          	auipc	ra,0x5
    10de:	e4c080e7          	jalr	-436(ra) # 5f26 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6b250513          	addi	a0,a0,1714 # 67a0 <malloc+0x7c2>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e30080e7          	jalr	-464(ra) # 5f26 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	6be50513          	addi	a0,a0,1726 # 67c8 <malloc+0x7ea>
    1112:	00005097          	auipc	ra,0x5
    1116:	e14080e7          	jalr	-492(ra) # 5f26 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	6d250513          	addi	a0,a0,1746 # 67f8 <malloc+0x81a>
    112e:	00005097          	auipc	ra,0x5
    1132:	df8080e7          	jalr	-520(ra) # 5f26 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	6c098993          	addi	s3,s3,1728 # 6818 <malloc+0x83a>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	69450513          	addi	a0,a0,1684 # 6828 <malloc+0x84a>
    119c:	00005097          	auipc	ra,0x5
    11a0:	d8a080e7          	jalr	-630(ra) # 5f26 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	64ea0a13          	addi	s4,s4,1614 # 6848 <malloc+0x86a>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	5fc50513          	addi	a0,a0,1532 # 6848 <malloc+0x86a>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	59450513          	addi	a0,a0,1428 # 6850 <malloc+0x872>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	c62080e7          	jalr	-926(ra) # 5f26 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	59450513          	addi	a0,a0,1428 # 6870 <malloc+0x892>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c42080e7          	jalr	-958(ra) # 5f26 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	59850513          	addi	a0,a0,1432 # 6890 <malloc+0x8b2>
    1300:	00005097          	auipc	ra,0x5
    1304:	c26080e7          	jalr	-986(ra) # 5f26 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	da498993          	addi	s3,s3,-604 # 6108 <malloc+0x12a>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	6fa78793          	addi	a5,a5,1786 # 7ae8 <malloc+0x1b0a>
  ...
  if(pid == 0){
    ...
    144e:	0de78793          	addi	a5,a5,222 # 8528 <malloc+0x254a>
    ...
    1472:	c9a50513          	addi	a0,a0,-870 # 6108 <malloc+0x12a>
    ...
    148a:	4b250513          	addi	a0,a0,1202 # 6938 <malloc+0x95a>
    148e:	00005097          	auipc	ra,0x5
    1492:	a98080e7          	jalr	-1384(ra) # 5f26 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	40a50513          	addi	a0,a0,1034 # 68b0 <malloc+0x8d2>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	a78080e7          	jalr	-1416(ra) # 5f26 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	40a50513          	addi	a0,a0,1034 # 68d0 <malloc+0x8f2>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	a58080e7          	jalr	-1448(ra) # 5f26 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	40850513          	addi	a0,a0,1032 # 68f0 <malloc+0x912>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a36080e7          	jalr	-1482(ra) # 5f26 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	41050513          	addi	a0,a0,1040 # 6918 <malloc+0x93a>
    1510:	00005097          	auipc	ra,0x5
    1514:	a16080e7          	jalr	-1514(ra) # 5f26 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	87650513          	addi	a0,a0,-1930 # 6d98 <malloc+0xdba>
    152a:	00005097          	auipc	ra,0x5
    152e:	9fc080e7          	jalr	-1540(ra) # 5f26 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	3f450513          	addi	a0,a0,1012 # 6960 <malloc+0x982>
    1574:	00005097          	auipc	ra,0x5
    1578:	9b2080e7          	jalr	-1614(ra) # 5f26 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	bc250513          	addi	a0,a0,-1086 # 6160 <malloc+0x182>
  ...
  if(pid == 0){
    ...
    15cc:	b98a0a13          	addi	s4,s4,-1128 # 6160 <malloc+0x182>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	3f0a8a93          	addi	s5,s5,1008 # 69c0 <malloc+0x9e2>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	35050513          	addi	a0,a0,848 # 6990 <malloc+0x9b2>
    1648:	00005097          	auipc	ra,0x5
    164c:	8de080e7          	jalr	-1826(ra) # 5f26 <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	34c50513          	addi	a0,a0,844 # 69a8 <malloc+0x9ca>
    1664:	00005097          	auipc	ra,0x5
    1668:	8c2080e7          	jalr	-1854(ra) # 5f26 <printf>
        exit(1);
    166c:	4505                	li	a0,1
    ...
    167e:	35650513          	addi	a0,a0,854 # 69d0 <malloc+0x9f2>
    1682:	00005097          	auipc	ra,0x5
    1686:	8a4080e7          	jalr	-1884(ra) # 5f26 <printf>
        exit(1);
    168a:	4505                	li	a0,1
    ...
    169c:	ac8a0a13          	addi	s4,s4,-1336 # 6160 <malloc+0x182>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	350a8a93          	addi	s5,s5,848 # 69f0 <malloc+0xa12>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	a7650513          	addi	a0,a0,-1418 # 6160 <malloc+0x182>
  ...
  exit(xstatus);
    ...
    170c:	2a050513          	addi	a0,a0,672 # 69a8 <malloc+0x9ca>
    1710:	00005097          	auipc	ra,0x5
    1714:	816080e7          	jalr	-2026(ra) # 5f26 <printf>
      exit(1);
    1718:	4505                	li	a0,1
    ...
    172a:	2d250513          	addi	a0,a0,722 # 69f8 <malloc+0xa1a>
    172e:	00004097          	auipc	ra,0x4
    1732:	7f8080e7          	jalr	2040(ra) # 5f26 <printf>
      exit(1);
    1736:	4505                	li	a0,1
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	9ba78793          	addi	a5,a5,-1606 # 6108 <malloc+0x12a>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2be78793          	addi	a5,a5,702 # 6a18 <malloc+0xa3a>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2b650513          	addi	a0,a0,694 # 6a20 <malloc+0xa42>
  ...
  if(pid == 0) {
    ...
    179c:	28850513          	addi	a0,a0,648 # 6a20 <malloc+0xa42>
    ...
    17b8:	28c50513          	addi	a0,a0,652 # 6a40 <malloc+0xa62>
    17bc:	00004097          	auipc	ra,0x4
    17c0:	76a080e7          	jalr	1898(ra) # 5f26 <printf>
      exit(1);
    17c4:	4505                	li	a0,1
    ...
    17d4:	1c050513          	addi	a0,a0,448 # 6990 <malloc+0x9b2>
    17d8:	00004097          	auipc	ra,0x4
    17dc:	74e080e7          	jalr	1870(ra) # 5f26 <printf>
     exit(1);
    17e0:	4505                	li	a0,1
    ...
    17f0:	23c50513          	addi	a0,a0,572 # 6a28 <malloc+0xa4a>
    17f4:	00004097          	auipc	ra,0x4
    17f8:	732080e7          	jalr	1842(ra) # 5f26 <printf>
      exit(1);
    17fc:	4505                	li	a0,1
    ...
    180e:	8fe50513          	addi	a0,a0,-1794 # 6108 <malloc+0x12a>
  ...
  if(xstatus != 0)
    ...
    1842:	21250513          	addi	a0,a0,530 # 6a50 <malloc+0xa72>
    1846:	00004097          	auipc	ra,0x4
    184a:	6e0080e7          	jalr	1760(ra) # 5f26 <printf>
      exit(1);
    184e:	4505                	li	a0,1
    ...
    185e:	20e50513          	addi	a0,a0,526 # 6a68 <malloc+0xa8a>
    1862:	00004097          	auipc	ra,0x4
    1866:	6c4080e7          	jalr	1732(ra) # 5f26 <printf>
    186a:	b7d1                	j	182e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186c:	4581                	li	a1,0
    186e:	00005517          	auipc	a0,0x5
    1872:	1b250513          	addi	a0,a0,434 # 6a20 <malloc+0xa42>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c4050513          	addi	a0,a0,-960 # 64d8 <malloc+0x4fa>
    18a0:	00004097          	auipc	ra,0x4
    18a4:	686080e7          	jalr	1670(ra) # 5f26 <printf>
    exit(1);
    18a8:	4505                	li	a0,1
    ...
    18b8:	0f450513          	addi	a0,a0,244 # 69a8 <malloc+0x9ca>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	66a080e7          	jalr	1642(ra) # 5f26 <printf>
    exit(1);
    18c4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d2:	15250513          	addi	a0,a0,338 # 6a20 <malloc+0xa42>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	18850513          	addi	a0,a0,392 # 6a80 <malloc+0xaa2>
    1900:	00004097          	auipc	ra,0x4
    1904:	626080e7          	jalr	1574(ra) # 5f26 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	0e050513          	addi	a0,a0,224 # 6a98 <malloc+0xaba>
    19c0:	00004097          	auipc	ra,0x4
    19c4:	566080e7          	jalr	1382(ra) # 5f26 <printf>
    exit(1);
    19c8:	4505                	li	a0,1
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	07250513          	addi	a0,a0,114 # 6ab0 <malloc+0xad2>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	4e0080e7          	jalr	1248(ra) # 5f26 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
    ...
    1a5e:	06e50513          	addi	a0,a0,110 # 6ac8 <malloc+0xaea>
    1a62:	00004097          	auipc	ra,0x4
    1a66:	4c4080e7          	jalr	1220(ra) # 5f26 <printf>
}
    ...
    1a90:	05450513          	addi	a0,a0,84 # 6ae0 <malloc+0xb02>
    1a94:	00004097          	auipc	ra,0x4
    1a98:	492080e7          	jalr	1170(ra) # 5f26 <printf>
      exit(1);
    1a9c:	4505                	li	a0,1
    ...
    1ad0:	03450513          	addi	a0,a0,52 # 6b00 <malloc+0xb22>
    1ad4:	00004097          	auipc	ra,0x4
    1ad8:	452080e7          	jalr	1106(ra) # 5f26 <printf>
    exit(1);
    1adc:	4505                	li	a0,1
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e5250513          	addi	a0,a0,-430 # 6990 <malloc+0x9b2>
    1b46:	00004097          	auipc	ra,0x4
    1b4a:	3e0080e7          	jalr	992(ra) # 5f26 <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5e:	fbe50513          	addi	a0,a0,-66 # 6b18 <malloc+0xb3a>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	3c4080e7          	jalr	964(ra) # 5f26 <printf>
        exit(1);
    1b6a:	4505                	li	a0,1
    ...
    1b7a:	fba50513          	addi	a0,a0,-70 # 6b30 <malloc+0xb52>
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	3a8080e7          	jalr	936(ra) # 5f26 <printf>
        exit(1);
    1b86:	4505                	li	a0,1
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	da250513          	addi	a0,a0,-606 # 6990 <malloc+0x9b2>
    1bf6:	00004097          	auipc	ra,0x4
    1bfa:	330080e7          	jalr	816(ra) # 5f26 <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c16:	d7e50513          	addi	a0,a0,-642 # 6990 <malloc+0x9b2>
    1c1a:	00004097          	auipc	ra,0x4
    1c1e:	30c080e7          	jalr	780(ra) # 5f26 <printf>
        exit(1);
    1c22:	4505                	li	a0,1
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	ec450513          	addi	a0,a0,-316 # 6b50 <malloc+0xb72>
    1c94:	00004097          	auipc	ra,0x4
    1c98:	292080e7          	jalr	658(ra) # 5f26 <printf>
      exit(1);
    1c9c:	4505                	li	a0,1
    ...
    1ca2:	ef0080e7          	jalr	-272(ra) # 5b8e <exit>
{
    ...
    1ce8:	e7c50513          	addi	a0,a0,-388 # 6b60 <malloc+0xb82>
    1cec:	00004097          	auipc	ra,0x4
    1cf0:	23a080e7          	jalr	570(ra) # 5f26 <printf>
      exit(1);
    1cf4:	4505                	li	a0,1
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	06650513          	addi	a0,a0,102 # 6d98 <malloc+0xdba>
    1d3a:	00004097          	auipc	ra,0x4
    1d3e:	1ec080e7          	jalr	492(ra) # 5f26 <printf>
      exit(1);
    1d42:	4505                	li	a0,1
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	fc850513          	addi	a0,a0,-56 # 6d98 <malloc+0xdba>
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	14e080e7          	jalr	334(ra) # 5f26 <printf>
      exit(1);
    1de0:	4505                	li	a0,1
    ...
    1e00:	c2c50513          	addi	a0,a0,-980 # 6a28 <malloc+0xa4a>
    1e04:	00004097          	auipc	ra,0x4
    1e08:	122080e7          	jalr	290(ra) # 5f26 <printf>
          exit(1);
    1e0c:	4505                	li	a0,1
    ...
    1e72:	d1250513          	addi	a0,a0,-750 # 6b80 <malloc+0xba2>
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	0b0080e7          	jalr	176(ra) # 5f26 <printf>
            exit(1);
    1e7e:	4505                	li	a0,1
    ...
    1ea6:	cf650513          	addi	a0,a0,-778 # 6b98 <malloc+0xbba>
    1eaa:	00004097          	auipc	ra,0x4
    1eae:	07c080e7          	jalr	124(ra) # 5f26 <printf>
        exit(1);
    1eb2:	4505                	li	a0,1
    ...
    1f0c:	cb850513          	addi	a0,a0,-840 # 6bc0 <malloc+0xbe2>
    1f10:	00004097          	auipc	ra,0x4
    1f14:	016080e7          	jalr	22(ra) # 5f26 <printf>
        exit(1);
    1f18:	4505                	li	a0,1
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	1d050513          	addi	a0,a0,464 # 6178 <malloc+0x19a>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	194a8a93          	addi	s5,s5,404 # 6178 <malloc+0x19a>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	bfcb8b93          	addi	s7,s7,-1028 # 6be8 <malloc+0xc0a>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	99850513          	addi	a0,a0,-1640 # 6990 <malloc+0x9b2>
    2000:	00004097          	auipc	ra,0x4
    2004:	f26080e7          	jalr	-218(ra) # 5f26 <printf>
    exit(1);
    2008:	4505                	li	a0,1
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b4e50513          	addi	a0,a0,-1202 # 6c08 <malloc+0xc2a>
    20c2:	00004097          	auipc	ra,0x4
    20c6:	e64080e7          	jalr	-412(ra) # 5f26 <printf>
    exit(1);
    20ca:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2120:	ad450513          	addi	a0,a0,-1324 # 6bf0 <malloc+0xc12>
    2124:	00004097          	auipc	ra,0x4
    2128:	e02080e7          	jalr	-510(ra) # 5f26 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	af850513          	addi	a0,a0,-1288 # 6c30 <malloc+0xc52>
    2140:	00004097          	auipc	ra,0x4
    2144:	de6080e7          	jalr	-538(ra) # 5f26 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	af450513          	addi	a0,a0,-1292 # 6c48 <malloc+0xc6a>
    215c:	00004097          	auipc	ra,0x4
    2160:	dca080e7          	jalr	-566(ra) # 5f26 <printf>
    exit(1);
    2164:	4505                	li	a0,1
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	7bc50513          	addi	a0,a0,1980 # 6990 <malloc+0x9b2>
    21dc:	00004097          	auipc	ra,0x4
    21e0:	d4a080e7          	jalr	-694(ra) # 5f26 <printf>
      exit(1);
    21e4:	4505                	li	a0,1
    ...
    21fa:	a6a50513          	addi	a0,a0,-1430 # 6c60 <malloc+0xc82>
    21fe:	00004097          	auipc	ra,0x4
    2202:	d28080e7          	jalr	-728(ra) # 5f26 <printf>
      exit(1);
    2206:	4505                	li	a0,1
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	71850513          	addi	a0,a0,1816 # 6990 <malloc+0x9b2>
    2280:	00004097          	auipc	ra,0x4
    2284:	ca6080e7          	jalr	-858(ra) # 5f26 <printf>
      exit(1);
    2288:	4505                	li	a0,1
    ...
    22a8:	9dc50513          	addi	a0,a0,-1572 # 6c80 <malloc+0xca2>
    22ac:	00004097          	auipc	ra,0x4
    22b0:	c7a080e7          	jalr	-902(ra) # 5f26 <printf>
      exit(1);
    22b4:	4505                	li	a0,1
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	9c450513          	addi	a0,a0,-1596 # 6c98 <malloc+0xcba>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	99250513          	addi	a0,a0,-1646 # 6c98 <malloc+0xcba>
  ...
  close(fd);
    ...
    2340:	96c70713          	addi	a4,a4,-1684 # 6ca8 <malloc+0xcca>
    ...
    2394:	9f850513          	addi	a0,a0,-1544 # 6d88 <malloc+0xdaa>
    2398:	00004097          	auipc	ra,0x4
    239c:	b8e080e7          	jalr	-1138(ra) # 5f26 <printf>
    exit(1);
    23a0:	4505                	li	a0,1
    ...
    23b8:	9f450513          	addi	a0,a0,-1548 # 6da8 <malloc+0xdca>
    23bc:	00004097          	auipc	ra,0x4
    23c0:	b6a080e7          	jalr	-1174(ra) # 5f26 <printf>
    exit(1);
    23c4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	9b650513          	addi	a0,a0,-1610 # 6dc8 <malloc+0xdea>
    241a:	00004097          	auipc	ra,0x4
    241e:	b0c080e7          	jalr	-1268(ra) # 5f26 <printf>
    exit(1);
    2422:	4505                	li	a0,1
    ...
    2432:	56250513          	addi	a0,a0,1378 # 6990 <malloc+0x9b2>
    2436:	00004097          	auipc	ra,0x4
    243a:	af0080e7          	jalr	-1296(ra) # 5f26 <printf>
    exit(1);
    243e:	4505                	li	a0,1
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	4f450513          	addi	a0,a0,1268 # 6990 <malloc+0x9b2>
    24a4:	00004097          	auipc	ra,0x4
    24a8:	a82080e7          	jalr	-1406(ra) # 5f26 <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	88050513          	addi	a0,a0,-1920 # 6d98 <malloc+0xdba>
    2520:	00004097          	auipc	ra,0x4
    2524:	a06080e7          	jalr	-1530(ra) # 5f26 <printf>
      exit(1);
    2528:	4505                	li	a0,1
    ...
    25cc:	82850513          	addi	a0,a0,-2008 # 6df0 <malloc+0xe12>
    25d0:	00004097          	auipc	ra,0x4
    25d4:	956080e7          	jalr	-1706(ra) # 5f26 <printf>
            exit(1);
    25d8:	4505                	li	a0,1
    ...
    25ec:	bf050513          	addi	a0,a0,-1040 # 61d8 <malloc+0x1fa>
    25f0:	00004097          	auipc	ra,0x4
    25f4:	936080e7          	jalr	-1738(ra) # 5f26 <printf>
            exit(1);
    25f8:	4505                	li	a0,1
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	46878793          	addi	a5,a5,1128 # 7ae8 <malloc+0x1b0a>
  ...
  if(ret != -1){
    ...
    26c6:	74650513          	addi	a0,a0,1862 # 6e08 <malloc+0xe2a>
    26ca:	00004097          	auipc	ra,0x4
    26ce:	85c080e7          	jalr	-1956(ra) # 5f26 <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e4:	1d050513          	addi	a0,a0,464 # 68b0 <malloc+0x8d2>
    26e8:	00004097          	auipc	ra,0x4
    26ec:	83e080e7          	jalr	-1986(ra) # 5f26 <printf>
    exit(1);
    26f0:	4505                	li	a0,1
    ...
    2702:	1d250513          	addi	a0,a0,466 # 68d0 <malloc+0x8f2>
    2706:	00004097          	auipc	ra,0x4
    270a:	820080e7          	jalr	-2016(ra) # 5f26 <printf>
    exit(1);
    270e:	4505                	li	a0,1
    ...
    2722:	1d250513          	addi	a0,a0,466 # 68f0 <malloc+0x912>
    2726:	00004097          	auipc	ra,0x4
    272a:	800080e7          	jalr	-2048(ra) # 5f26 <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    2740:	1dc50513          	addi	a0,a0,476 # 6918 <malloc+0x93a>
    2744:	00003097          	auipc	ra,0x3
    2748:	7e2080e7          	jalr	2018(ra) # 5f26 <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	6c050513          	addi	a0,a0,1728 # 6e48 <malloc+0xe6a>
  ...
  if(n >= 0){
    ...
    27bc:	6b050513          	addi	a0,a0,1712 # 6e68 <malloc+0xe8a>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	766080e7          	jalr	1894(ra) # 5f26 <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	63e50513          	addi	a0,a0,1598 # 6e10 <malloc+0xe32>
    27da:	00003097          	auipc	ra,0x3
    27de:	74c080e7          	jalr	1868(ra) # 5f26 <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	63c50513          	addi	a0,a0,1596 # 6e28 <malloc+0xe4a>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	732080e7          	jalr	1842(ra) # 5f26 <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	64a50513          	addi	a0,a0,1610 # 6e50 <malloc+0xe72>
    280e:	00003097          	auipc	ra,0x3
    2812:	718080e7          	jalr	1816(ra) # 5f26 <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    282e:	61e50513          	addi	a0,a0,1566 # 6e48 <malloc+0xe6a>
    2832:	00003097          	auipc	ra,0x3
    2836:	3ac080e7          	jalr	940(ra) # 5bde <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	aa450513          	addi	a0,a0,-1372 # 62e0 <malloc+0x302>
  ...
  if(n >= 0){
    ...
    286a:	63250513          	addi	a0,a0,1586 # 6e98 <malloc+0xeba>
    286e:	00003097          	auipc	ra,0x3
    2872:	6b8080e7          	jalr	1720(ra) # 5f26 <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	5d050513          	addi	a0,a0,1488 # 6e50 <malloc+0xe72>
    2888:	00003097          	auipc	ra,0x3
    288c:	69e080e7          	jalr	1694(ra) # 5f26 <printf>
    exit(1);
    2890:	4505                	li	a0,1
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	5c050513          	addi	a0,a0,1472 # 6ec0 <malloc+0xee2>
    2908:	00003097          	auipc	ra,0x3
    290c:	61e080e7          	jalr	1566(ra) # 5f26 <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	58e50513          	addi	a0,a0,1422 # 6ee0 <malloc+0xf02>
    295a:	00003097          	auipc	ra,0x3
    295e:	5cc080e7          	jalr	1484(ra) # 5f26 <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	58a50513          	addi	a0,a0,1418 # 6f40 <malloc+0xf62>
    29be:	00003097          	auipc	ra,0x3
    29c2:	568080e7          	jalr	1384(ra) # 5f26 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	52850513          	addi	a0,a0,1320 # 6f00 <malloc+0xf22>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	546080e7          	jalr	1350(ra) # 5f26 <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	52c50513          	addi	a0,a0,1324 # 6f20 <malloc+0xf42>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	52a080e7          	jalr	1322(ra) # 5f26 <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	42250513          	addi	a0,a0,1058 # 6f60 <malloc+0xf82>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	3e0080e7          	jalr	992(ra) # 5f26 <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	44e50513          	addi	a0,a0,1102 # 6fa8 <malloc+0xfca>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	3c4080e7          	jalr	964(ra) # 5f26 <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	44e50513          	addi	a0,a0,1102 # 6fc8 <malloc+0xfea>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	3a4080e7          	jalr	932(ra) # 5f26 <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	46e50513          	addi	a0,a0,1134 # 7008 <malloc+0x102a>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	384080e7          	jalr	900(ra) # 5f26 <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	48250513          	addi	a0,a0,1154 # 7038 <malloc+0x105a>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	368080e7          	jalr	872(ra) # 5f26 <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	49a50513          	addi	a0,a0,1178 # 7070 <malloc+0x1092>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	348080e7          	jalr	840(ra) # 5f26 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	48850513          	addi	a0,a0,1160 # 7098 <malloc+0x10ba>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fb6080e7          	jalr	-74(ra) # 5bce <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	47650513          	addi	a0,a0,1142 # 7098 <malloc+0x10ba>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	42a50513          	addi	a0,a0,1066 # 70a0 <malloc+0x10c2>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	2a8080e7          	jalr	680(ra) # 5f26 <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	42650513          	addi	a0,a0,1062 # 70b8 <malloc+0x10da>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	28c080e7          	jalr	652(ra) # 5f26 <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	dea50513          	addi	a0,a0,-534 # 6a98 <malloc+0xaba>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	270080e7          	jalr	624(ra) # 5f26 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	3f850513          	addi	a0,a0,1016 # 70d0 <malloc+0x10f2>
  ...
  close(fd);
    ...
    2d24:	c8850513          	addi	a0,a0,-888 # 69a8 <malloc+0x9ca>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	1fe080e7          	jalr	510(ra) # 5f26 <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	02a50513          	addi	a0,a0,42 # 6d98 <malloc+0xdba>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	1b0080e7          	jalr	432(ra) # 5f26 <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	fd450513          	addi	a0,a0,-44 # 6d98 <malloc+0xdba>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	15a080e7          	jalr	346(ra) # 5f26 <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e28:	f7450513          	addi	a0,a0,-140 # 6d98 <malloc+0xdba>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	0fa080e7          	jalr	250(ra) # 5f26 <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e0050513          	addi	a0,a0,-512 # 6d98 <malloc+0xdba>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	f86080e7          	jalr	-122(ra) # 5f26 <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	11c50513          	addi	a0,a0,284 # 6108 <malloc+0x12a>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	18078793          	addi	a5,a5,384 # 6178 <malloc+0x19a>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	27e50513          	addi	a0,a0,638 # 72a8 <malloc+0x12ca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	0c450513          	addi	a0,a0,196 # 7100 <malloc+0x1122>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	10650513          	addi	a0,a0,262 # 7158 <malloc+0x117a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	16050513          	addi	a0,a0,352 # 71d0 <malloc+0x11f2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	1b450513          	addi	a0,a0,436 # 7240 <malloc+0x1262>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	1fa50513          	addi	a0,a0,506 # 7298 <malloc+0x12ba>
  ...
  unlink("12345678901234");
    ...
    3120:	fbc50513          	addi	a0,a0,-68 # 70d8 <malloc+0x10fa>
    3124:	00003097          	auipc	ra,0x3
    3128:	e02080e7          	jalr	-510(ra) # 5f26 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	fe850513          	addi	a0,a0,-24 # 7120 <malloc+0x1142>
    3140:	00003097          	auipc	ra,0x3
    3144:	de6080e7          	jalr	-538(ra) # 5f26 <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	03450513          	addi	a0,a0,52 # 7188 <malloc+0x11aa>
    315c:	00003097          	auipc	ra,0x3
    3160:	dca080e7          	jalr	-566(ra) # 5f26 <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	09050513          	addi	a0,a0,144 # 7200 <malloc+0x1222>
    3178:	00003097          	auipc	ra,0x3
    317c:	dae080e7          	jalr	-594(ra) # 5f26 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	0d450513          	addi	a0,a0,212 # 7260 <malloc+0x1282>
    3194:	00003097          	auipc	ra,0x3
    3198:	d92080e7          	jalr	-622(ra) # 5f26 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	11050513          	addi	a0,a0,272 # 72b8 <malloc+0x12da>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	d76080e7          	jalr	-650(ra) # 5f26 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	0fc50513          	addi	a0,a0,252 # 72f0 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	0e250513          	addi	a0,a0,226 # 7300 <malloc+0x1322>
    3226:	00003097          	auipc	ra,0x3
    322a:	d00080e7          	jalr	-768(ra) # 5f26 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	04250513          	addi	a0,a0,66 # 72f0 <malloc+0x1312>
  ...
  unlink("diskfulldir");
    ...
    32c6:	02e50513          	addi	a0,a0,46 # 72f0 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f3050513          	addi	a0,a0,-208 # 7320 <malloc+0x1342>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b2e080e7          	jalr	-1234(ra) # 5f26 <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f4250513          	addi	a0,a0,-190 # 7350 <malloc+0x1372>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f2e50513          	addi	a0,a0,-210 # 7350 <malloc+0x1372>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f5a50513          	addi	a0,a0,-166 # 7390 <malloc+0x13b2>
  ...
  if(chdir("/") < 0){
    ...
    344e:	f7650513          	addi	a0,a0,-138 # 73c0 <malloc+0x13e2>
    ...
    346e:	eee50513          	addi	a0,a0,-274 # 7358 <malloc+0x137a>
    3472:	00003097          	auipc	ra,0x3
    3476:	ab4080e7          	jalr	-1356(ra) # 5f26 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	eea50513          	addi	a0,a0,-278 # 7370 <malloc+0x1392>
    348e:	00003097          	auipc	ra,0x3
    3492:	a98080e7          	jalr	-1384(ra) # 5f26 <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	efe50513          	addi	a0,a0,-258 # 73a0 <malloc+0x13c2>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	a7c080e7          	jalr	-1412(ra) # 5f26 <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	f0a50513          	addi	a0,a0,-246 # 73c8 <malloc+0x13ea>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	a60080e7          	jalr	-1440(ra) # 5f26 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e5e50513          	addi	a0,a0,-418 # 7350 <malloc+0x1372>
    ...
    350a:	e4a50513          	addi	a0,a0,-438 # 7350 <malloc+0x1372>
    ...
    351e:	e7650513          	addi	a0,a0,-394 # 7390 <malloc+0x13b2>
    ...
    353e:	45650513          	addi	a0,a0,1110 # 6990 <malloc+0x9b2>
    3542:	00003097          	auipc	ra,0x3
    3546:	9e4080e7          	jalr	-1564(ra) # 5f26 <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	e0250513          	addi	a0,a0,-510 # 7358 <malloc+0x137a>
    355e:	00003097          	auipc	ra,0x3
    3562:	9c8080e7          	jalr	-1592(ra) # 5f26 <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	e6e50513          	addi	a0,a0,-402 # 73e0 <malloc+0x1402>
    357a:	00003097          	auipc	ra,0x3
    357e:	9ac080e7          	jalr	-1620(ra) # 5f26 <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	e1250513          	addi	a0,a0,-494 # 73a0 <malloc+0x13c2>
    3596:	00003097          	auipc	ra,0x3
    359a:	990080e7          	jalr	-1648(ra) # 5f26 <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e2c50513          	addi	a0,a0,-468 # 73f8 <malloc+0x141a>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e1850513          	addi	a0,a0,-488 # 73f8 <malloc+0x141a>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e2450513          	addi	a0,a0,-476 # 7418 <malloc+0x143a>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	df050513          	addi	a0,a0,-528 # 73f8 <malloc+0x141a>
    ...
    362c:	d3050513          	addi	a0,a0,-720 # 7358 <malloc+0x137a>
    3630:	00003097          	auipc	ra,0x3
    3634:	8f6080e7          	jalr	-1802(ra) # 5f26 <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	dbc50513          	addi	a0,a0,-580 # 7400 <malloc+0x1422>
    364c:	00003097          	auipc	ra,0x3
    3650:	8da080e7          	jalr	-1830(ra) # 5f26 <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	dc050513          	addi	a0,a0,-576 # 7420 <malloc+0x1442>
    3668:	00003097          	auipc	ra,0x3
    366c:	8be080e7          	jalr	-1858(ra) # 5f26 <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	dbc50513          	addi	a0,a0,-580 # 7438 <malloc+0x145a>
    3684:	00003097          	auipc	ra,0x3
    3688:	8a2080e7          	jalr	-1886(ra) # 5f26 <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	edc50513          	addi	a0,a0,-292 # 7580 <malloc+0x15a2>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	532080e7          	jalr	1330(ra) # 5bde <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	d9c50513          	addi	a0,a0,-612 # 7450 <malloc+0x1472>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	da450513          	addi	a0,a0,-604 # 7470 <malloc+0x1492>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	e9c58593          	addi	a1,a1,-356 # 7580 <malloc+0x15a2>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d5250513          	addi	a0,a0,-686 # 7450 <malloc+0x1472>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	db650513          	addi	a0,a0,-586 # 74c8 <malloc+0x14ea>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	dc650513          	addi	a0,a0,-570 # 74f0 <malloc+0x1512>
  ...
  write(fd, "FF", 2);
    ...
    3746:	dde58593          	addi	a1,a1,-546 # 7520 <malloc+0x1542>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	dca50513          	addi	a0,a0,-566 # 7528 <malloc+0x154a>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	dd258593          	addi	a1,a1,-558 # 7578 <malloc+0x159a>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d4250513          	addi	a0,a0,-702 # 74f0 <malloc+0x1512>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d2e50513          	addi	a0,a0,-722 # 74f0 <malloc+0x1512>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d1850513          	addi	a0,a0,-744 # 74f0 <malloc+0x1512>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	c6450513          	addi	a0,a0,-924 # 7450 <malloc+0x1472>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e1050513          	addi	a0,a0,-496 # 7610 <malloc+0x1632>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e2c50513          	addi	a0,a0,-468 # 7640 <malloc+0x1662>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e4850513          	addi	a0,a0,-440 # 7670 <malloc+0x1692>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d3a50513          	addi	a0,a0,-710 # 7578 <malloc+0x159a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	c7850513          	addi	a0,a0,-904 # 74f0 <malloc+0x1512>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	e7050513          	addi	a0,a0,-400 # 7700 <malloc+0x1722>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	e8850513          	addi	a0,a0,-376 # 7730 <malloc+0x1752>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	b9050513          	addi	a0,a0,-1136 # 7450 <malloc+0x1472>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	b7a50513          	addi	a0,a0,-1158 # 7450 <malloc+0x1472>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	b6450513          	addi	a0,a0,-1180 # 7450 <malloc+0x1472>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	ec058593          	addi	a1,a1,-320 # 77c0 <malloc+0x17e2>
    3908:	00004517          	auipc	a0,0x4
    390c:	df850513          	addi	a0,a0,-520 # 7700 <malloc+0x1722>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	ea458593          	addi	a1,a1,-348 # 77c0 <malloc+0x17e2>
    3924:	00004517          	auipc	a0,0x4
    3928:	e0c50513          	addi	a0,a0,-500 # 7730 <malloc+0x1752>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c4058593          	addi	a1,a1,-960 # 7578 <malloc+0x159a>
    3940:	00004517          	auipc	a0,0x4
    3944:	b3050513          	addi	a0,a0,-1232 # 7470 <malloc+0x1492>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	dac50513          	addi	a0,a0,-596 # 7700 <malloc+0x1722>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	dc850513          	addi	a0,a0,-568 # 7730 <malloc+0x1752>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	bfc50513          	addi	a0,a0,-1028 # 7578 <malloc+0x159a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	da050513          	addi	a0,a0,-608 # 7730 <malloc+0x1752>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d5c50513          	addi	a0,a0,-676 # 7700 <malloc+0x1722>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	ab850513          	addi	a0,a0,-1352 # 7470 <malloc+0x1492>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f4450513          	addi	a0,a0,-188 # 7910 <malloc+0x1932>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	b9850513          	addi	a0,a0,-1128 # 7578 <malloc+0x159a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	a7c50513          	addi	a0,a0,-1412 # 7470 <malloc+0x1492>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a4850513          	addi	a0,a0,-1464 # 7450 <malloc+0x1472>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	f6450513          	addi	a0,a0,-156 # 7980 <malloc+0x19a2>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a2050513          	addi	a0,a0,-1504 # 7450 <malloc+0x1472>
    ...
    3a56:	a0650513          	addi	a0,a0,-1530 # 7458 <malloc+0x147a>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	4cc080e7          	jalr	1228(ra) # 5f26 <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	a0a50513          	addi	a0,a0,-1526 # 7478 <malloc+0x149a>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	4b0080e7          	jalr	1200(ra) # 5f26 <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	a0e50513          	addi	a0,a0,-1522 # 7498 <malloc+0x14ba>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	494080e7          	jalr	1172(ra) # 5f26 <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a2a50513          	addi	a0,a0,-1494 # 74d0 <malloc+0x14f2>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	478080e7          	jalr	1144(ra) # 5f26 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a3e50513          	addi	a0,a0,-1474 # 7500 <malloc+0x1522>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	45c080e7          	jalr	1116(ra) # 5f26 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a5a50513          	addi	a0,a0,-1446 # 7538 <malloc+0x155a>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	440080e7          	jalr	1088(ra) # 5f26 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a5e50513          	addi	a0,a0,-1442 # 7558 <malloc+0x157a>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	424080e7          	jalr	1060(ra) # 5f26 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	a7250513          	addi	a0,a0,-1422 # 7588 <malloc+0x15aa>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	408080e7          	jalr	1032(ra) # 5f26 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	a7e50513          	addi	a0,a0,-1410 # 75b0 <malloc+0x15d2>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	3ec080e7          	jalr	1004(ra) # 5f26 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	a8250513          	addi	a0,a0,-1406 # 75d0 <malloc+0x15f2>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	3d0080e7          	jalr	976(ra) # 5f26 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	a8e50513          	addi	a0,a0,-1394 # 75f8 <malloc+0x161a>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	3b4080e7          	jalr	948(ra) # 5f26 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	a9a50513          	addi	a0,a0,-1382 # 7620 <malloc+0x1642>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	398080e7          	jalr	920(ra) # 5f26 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	aae50513          	addi	a0,a0,-1362 # 7650 <malloc+0x1672>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	37c080e7          	jalr	892(ra) # 5f26 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	aba50513          	addi	a0,a0,-1350 # 7678 <malloc+0x169a>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	360080e7          	jalr	864(ra) # 5f26 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	ab650513          	addi	a0,a0,-1354 # 7690 <malloc+0x16b2>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	344080e7          	jalr	836(ra) # 5f26 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	aba50513          	addi	a0,a0,-1350 # 76b0 <malloc+0x16d2>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	328080e7          	jalr	808(ra) # 5f26 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	abe50513          	addi	a0,a0,-1346 # 76d0 <malloc+0x16f2>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	30c080e7          	jalr	780(ra) # 5f26 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	ae250513          	addi	a0,a0,-1310 # 7710 <malloc+0x1732>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	2f0080e7          	jalr	752(ra) # 5f26 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	af650513          	addi	a0,a0,-1290 # 7740 <malloc+0x1762>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	2d4080e7          	jalr	724(ra) # 5f26 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	afa50513          	addi	a0,a0,-1286 # 7760 <malloc+0x1782>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	2b8080e7          	jalr	696(ra) # 5f26 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	afe50513          	addi	a0,a0,-1282 # 7780 <malloc+0x17a2>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	29c080e7          	jalr	668(ra) # 5f26 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	b0250513          	addi	a0,a0,-1278 # 77a0 <malloc+0x17c2>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	280080e7          	jalr	640(ra) # 5f26 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b1650513          	addi	a0,a0,-1258 # 77d0 <malloc+0x17f2>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	264080e7          	jalr	612(ra) # 5f26 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b2250513          	addi	a0,a0,-1246 # 77f8 <malloc+0x181a>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	248080e7          	jalr	584(ra) # 5f26 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b2e50513          	addi	a0,a0,-1234 # 7820 <malloc+0x1842>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	22c080e7          	jalr	556(ra) # 5f26 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b3a50513          	addi	a0,a0,-1222 # 7848 <malloc+0x186a>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	210080e7          	jalr	528(ra) # 5f26 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b3e50513          	addi	a0,a0,-1218 # 7868 <malloc+0x188a>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	1f4080e7          	jalr	500(ra) # 5f26 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b4250513          	addi	a0,a0,-1214 # 7888 <malloc+0x18aa>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	1d8080e7          	jalr	472(ra) # 5f26 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b4e50513          	addi	a0,a0,-1202 # 78b0 <malloc+0x18d2>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	1bc080e7          	jalr	444(ra) # 5f26 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b5250513          	addi	a0,a0,-1198 # 78d0 <malloc+0x18f2>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	1a0080e7          	jalr	416(ra) # 5f26 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b5650513          	addi	a0,a0,-1194 # 78f0 <malloc+0x1912>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	184080e7          	jalr	388(ra) # 5f26 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b6250513          	addi	a0,a0,-1182 # 7918 <malloc+0x193a>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	168080e7          	jalr	360(ra) # 5f26 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	7de50513          	addi	a0,a0,2014 # 75b0 <malloc+0x15d2>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	14c080e7          	jalr	332(ra) # 5f26 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b4a50513          	addi	a0,a0,-1206 # 7938 <malloc+0x195a>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	130080e7          	jalr	304(ra) # 5f26 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b4e50513          	addi	a0,a0,-1202 # 7958 <malloc+0x197a>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	114080e7          	jalr	276(ra) # 5f26 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	b6250513          	addi	a0,a0,-1182 # 7988 <malloc+0x19aa>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	0f8080e7          	jalr	248(ra) # 5f26 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b6650513          	addi	a0,a0,-1178 # 79a8 <malloc+0x19ca>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	0dc080e7          	jalr	220(ra) # 5f26 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b5850513          	addi	a0,a0,-1192 # 79c0 <malloc+0x19e2>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b4650513          	addi	a0,a0,-1210 # 79c0 <malloc+0x19e2>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	96450513          	addi	a0,a0,-1692 # 67f0 <malloc+0x812>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	57a50513          	addi	a0,a0,1402 # 7418 <malloc+0x143a>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	51050513          	addi	a0,a0,1296 # 73c0 <malloc+0x13e2>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	b6650513          	addi	a0,a0,-1178 # 7a28 <malloc+0x1a4a>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	b7c50513          	addi	a0,a0,-1156 # 7a50 <malloc+0x1a72>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	ada50513          	addi	a0,a0,-1318 # 79c0 <malloc+0x19e2>
    ...
    3f08:	ac450513          	addi	a0,a0,-1340 # 79c8 <malloc+0x19ea>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	01a080e7          	jalr	26(ra) # 5f26 <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	ac050513          	addi	a0,a0,-1344 # 79e0 <malloc+0x1a02>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	ffe080e7          	jalr	-2(ra) # 5f26 <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	abc50513          	addi	a0,a0,-1348 # 79f8 <malloc+0x1a1a>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	fe2080e7          	jalr	-30(ra) # 5f26 <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	ab850513          	addi	a0,a0,-1352 # 7a10 <malloc+0x1a32>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	fc6080e7          	jalr	-58(ra) # 5f26 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	45450513          	addi	a0,a0,1108 # 73c8 <malloc+0x13ea>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	faa080e7          	jalr	-86(ra) # 5f26 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	aa050513          	addi	a0,a0,-1376 # 7a30 <malloc+0x1a52>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	f8e080e7          	jalr	-114(ra) # 5f26 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	aac50513          	addi	a0,a0,-1364 # 7a58 <malloc+0x1a7a>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	f72080e7          	jalr	-142(ra) # 5f26 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	ab050513          	addi	a0,a0,-1360 # 7a78 <malloc+0x1a9a>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f56080e7          	jalr	-170(ra) # 5f26 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	aa450513          	addi	a0,a0,-1372 # 7a98 <malloc+0x1aba>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	a8850513          	addi	a0,a0,-1400 # 7a98 <malloc+0x1aba>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	abc50513          	addi	a0,a0,-1348 # 7ae0 <malloc+0x1b02>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	aa450513          	addi	a0,a0,-1372 # 7ae0 <malloc+0x1b02>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	a9050513          	addi	a0,a0,-1392 # 7ae0 <malloc+0x1b02>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	a7c50513          	addi	a0,a0,-1412 # 7ae0 <malloc+0x1b02>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	a6858593          	addi	a1,a1,-1432 # 7ae0 <malloc+0x1b02>
    4080:	00002517          	auipc	a0,0x2
    4084:	26050513          	addi	a0,a0,608 # 62e0 <malloc+0x302>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a0450513          	addi	a0,a0,-1532 # 7a98 <malloc+0x1aba>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	74650513          	addi	a0,a0,1862 # 67f0 <malloc+0x812>
  ...
  fd = open(".", 0);
    ...
    40c4:	73050513          	addi	a0,a0,1840 # 67f0 <malloc+0x812>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	0a458593          	addi	a1,a1,164 # 6178 <malloc+0x19a>
  ...
  close(fd);
    ...
    4104:	9a050513          	addi	a0,a0,-1632 # 7aa0 <malloc+0x1ac2>
    4108:	00002097          	auipc	ra,0x2
    410c:	e1e080e7          	jalr	-482(ra) # 5f26 <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	9a450513          	addi	a0,a0,-1628 # 7ac0 <malloc+0x1ae2>
    4124:	00002097          	auipc	ra,0x2
    4128:	e02080e7          	jalr	-510(ra) # 5f26 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	9b850513          	addi	a0,a0,-1608 # 7af0 <malloc+0x1b12>
    4140:	00002097          	auipc	ra,0x2
    4144:	de6080e7          	jalr	-538(ra) # 5f26 <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	99c50513          	addi	a0,a0,-1636 # 7af0 <malloc+0x1b12>
    415c:	00002097          	auipc	ra,0x2
    4160:	dca080e7          	jalr	-566(ra) # 5f26 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	9a850513          	addi	a0,a0,-1624 # 7b18 <malloc+0x1b3a>
    4178:	00002097          	auipc	ra,0x2
    417c:	dae080e7          	jalr	-594(ra) # 5f26 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9b450513          	addi	a0,a0,-1612 # 7b40 <malloc+0x1b62>
    4194:	00002097          	auipc	ra,0x2
    4198:	d92080e7          	jalr	-622(ra) # 5f26 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	9c050513          	addi	a0,a0,-1600 # 7b68 <malloc+0x1b8a>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	d76080e7          	jalr	-650(ra) # 5f26 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9cc50513          	addi	a0,a0,-1588 # 7b90 <malloc+0x1bb2>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d5a080e7          	jalr	-678(ra) # 5f26 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	9d050513          	addi	a0,a0,-1584 # 7bb0 <malloc+0x1bd2>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d3e080e7          	jalr	-706(ra) # 5f26 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	9dc50513          	addi	a0,a0,-1572 # 7bd8 <malloc+0x1bfa>
    4204:	00002097          	auipc	ra,0x2
    4208:	d22080e7          	jalr	-734(ra) # 5f26 <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	9c0a0a13          	addi	s4,s4,-1600 # 7bf0 <malloc+0x1c12>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4c048493          	addi	s1,s1,1216 # 76f8 <malloc+0x171a>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0a0a8a93          	addi	s5,s5,160 # 62e0 <malloc+0x302>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8a098993          	addi	s3,s3,-1888 # 7ae8 <malloc+0x1b0a>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9a450513          	addi	a0,a0,-1628 # 7bf8 <malloc+0x1c1a>
    425c:	00002097          	auipc	ra,0x2
    4260:	cca080e7          	jalr	-822(ra) # 5f26 <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	9a050513          	addi	a0,a0,-1632 # 7c10 <malloc+0x1c32>
    4278:	00002097          	auipc	ra,0x2
    427c:	cae080e7          	jalr	-850(ra) # 5f26 <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	11498993          	addi	s3,s3,276 # 7418 <malloc+0x143a>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	8e490913          	addi	s2,s2,-1820 # 7bf0 <malloc+0x1c12>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	09450513          	addi	a0,a0,148 # 73c0 <malloc+0x13e2>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	8cc50513          	addi	a0,a0,-1844 # 7c28 <malloc+0x1c4a>
  ...
  if(pid == 0){
    ...
    4384:	8a850513          	addi	a0,a0,-1880 # 7c28 <malloc+0x1c4a>
    ...
    439a:	8b250513          	addi	a0,a0,-1870 # 7c48 <malloc+0x1c6a>
    439e:	00002097          	auipc	ra,0x2
    43a2:	b88080e7          	jalr	-1144(ra) # 5f26 <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	87e50513          	addi	a0,a0,-1922 # 7c30 <malloc+0x1c52>
    43ba:	00002097          	auipc	ra,0x2
    43be:	b6c080e7          	jalr	-1172(ra) # 5f26 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	5c250513          	addi	a0,a0,1474 # 6990 <malloc+0x9b2>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b50080e7          	jalr	-1200(ra) # 5f26 <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	82c50513          	addi	a0,a0,-2004 # 7c28 <malloc+0x1c4a>
    ...
    4414:	77050513          	addi	a0,a0,1904 # 6b80 <malloc+0xba2>
    4418:	00002097          	auipc	ra,0x2
    441c:	b0e080e7          	jalr	-1266(ra) # 5f26 <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	82250513          	addi	a0,a0,-2014 # 7c70 <malloc+0x1c92>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	7f650513          	addi	a0,a0,2038 # 7c70 <malloc+0x1c92>
  ...
  sleep(10); // one second
    ...
    44b6:	69e50513          	addi	a0,a0,1694 # 6b50 <malloc+0xb72>
    44ba:	00002097          	auipc	ra,0x2
    44be:	a6c080e7          	jalr	-1428(ra) # 5f26 <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	7a448493          	addi	s1,s1,1956 # 7c70 <malloc+0x1c92>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
    ...
    44f8:	77c50513          	addi	a0,a0,1916 # 7c70 <malloc+0x1c92>
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	41650513          	addi	a0,a0,1046 # 6990 <malloc+0x9b2>
    4582:	00002097          	auipc	ra,0x2
    4586:	9a4080e7          	jalr	-1628(ra) # 5f26 <printf>
      exit(1);
    458a:	4505                	li	a0,1
    ...
    45a4:	6e050513          	addi	a0,a0,1760 # 7c80 <malloc+0x1ca2>
    45a8:	00002097          	auipc	ra,0x2
    45ac:	97e080e7          	jalr	-1666(ra) # 5f26 <printf>
       exit(1);
    45b0:	4505                	li	a0,1
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	57050513          	addi	a0,a0,1392 # 6b50 <malloc+0xb72>
    45e8:	00002097          	auipc	ra,0x2
    45ec:	93e080e7          	jalr	-1730(ra) # 5f26 <printf>
    exit(1);
    45f0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4612:	38250513          	addi	a0,a0,898 # 6990 <malloc+0x9b2>
    4616:	00002097          	auipc	ra,0x2
    461a:	910080e7          	jalr	-1776(ra) # 5f26 <printf>
    exit(1);
    461e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4656:	b2658593          	addi	a1,a1,-1242 # 6178 <malloc+0x19a>
    ...
    4680:	31450513          	addi	a0,a0,788 # 6990 <malloc+0x9b2>
    4684:	00002097          	auipc	ra,0x2
    4688:	8a2080e7          	jalr	-1886(ra) # 5f26 <printf>
     exit(1);
    468c:	4505                	li	a0,1
    ...
    469c:	60850513          	addi	a0,a0,1544 # 7ca0 <malloc+0x1cc2>
    46a0:	00002097          	auipc	ra,0x2
    46a4:	886080e7          	jalr	-1914(ra) # 5f26 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	5e450513          	addi	a0,a0,1508 # 7cb8 <malloc+0x1cda>
    46dc:	00002097          	auipc	ra,0x2
    46e0:	84a080e7          	jalr	-1974(ra) # 5f26 <printf>
}
  ...
  printf("kill... ");
    ...
    4704:	5d050513          	addi	a0,a0,1488 # 7cd0 <malloc+0x1cf2>
    4708:	00002097          	auipc	ra,0x2
    470c:	81e080e7          	jalr	-2018(ra) # 5f26 <printf>
  kill(pid1);
    4710:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4732:	5b250513          	addi	a0,a0,1458 # 7ce0 <malloc+0x1d02>
    4736:	00001097          	auipc	ra,0x1
    473a:	7f0080e7          	jalr	2032(ra) # 5f26 <printf>
  wait(0);
    473e:	4501                	li	a0,0
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	1e250513          	addi	a0,a0,482 # 6990 <malloc+0x9b2>
    47b6:	00001097          	auipc	ra,0x1
    47ba:	770080e7          	jalr	1904(ra) # 5f26 <printf>
      exit(1);
    47be:	4505                	li	a0,1
    ...
    47ce:	34e50513          	addi	a0,a0,846 # 6b18 <malloc+0xb3a>
    47d2:	00001097          	auipc	ra,0x1
    47d6:	754080e7          	jalr	1876(ra) # 5f26 <printf>
        exit(1);
    47da:	4505                	li	a0,1
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	25850513          	addi	a0,a0,600 # 6a98 <malloc+0xaba>
    4848:	00001097          	auipc	ra,0x1
    484c:	6de080e7          	jalr	1758(ra) # 5f26 <printf>
    exit(1);
    4850:	4505                	li	a0,1
    ...
    4878:	90458593          	addi	a1,a1,-1788 # 6178 <malloc+0x19a>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	3b850513          	addi	a0,a0,952 # 7cf0 <malloc+0x1d12>
    4940:	00001097          	auipc	ra,0x1
    4944:	5e6080e7          	jalr	1510(ra) # 5f26 <printf>
    exit(1);
    4948:	4505                	li	a0,1
    ...
    4958:	03c50513          	addi	a0,a0,60 # 6990 <malloc+0x9b2>
    495c:	00001097          	auipc	ra,0x1
    4960:	5ca080e7          	jalr	1482(ra) # 5f26 <printf>
    exit(1);
    4964:	4505                	li	a0,1
    ...
    49a4:	37050513          	addi	a0,a0,880 # 7d10 <malloc+0x1d32>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	57e080e7          	jalr	1406(ra) # 5f26 <printf>
    exit(1);
    49b0:	4505                	li	a0,1
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0e:	5d4080e7          	jalr	1492(ra) # 5fde <malloc>
    ...
    4a48:	2fc50513          	addi	a0,a0,764 # 7d40 <malloc+0x1d62>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	4da080e7          	jalr	1242(ra) # 5f26 <printf>
      exit(1);
    4a54:	4505                	li	a0,1
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	27650513          	addi	a0,a0,630 # 7d70 <malloc+0x1d92>
    4b02:	00001097          	auipc	ra,0x1
    4b06:	424080e7          	jalr	1060(ra) # 5f26 <printf>
    exit(1);
    4b0a:	4505                	li	a0,1
    ...
    4b1a:	28250513          	addi	a0,a0,642 # 7d98 <malloc+0x1dba>
    4b1e:	00001097          	auipc	ra,0x1
    4b22:	408080e7          	jalr	1032(ra) # 5f26 <printf>
      exit(1);
    4b26:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	20650513          	addi	a0,a0,518 # 7d60 <malloc+0x1d82>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	21e50513          	addi	a0,a0,542 # 7db8 <malloc+0x1dda>
    4ba2:	00001097          	auipc	ra,0x1
    4ba6:	384080e7          	jalr	900(ra) # 5f26 <printf>
    exit(1);
    4baa:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bda:	18a50513          	addi	a0,a0,394 # 7d60 <malloc+0x1d82>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	1e450513          	addi	a0,a0,484 # 7de0 <malloc+0x1e02>
    4c04:	00001097          	auipc	ra,0x1
    4c08:	322080e7          	jalr	802(ra) # 5f26 <printf>
    exit(1);
    4c0c:	4505                	li	a0,1
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	1b878793          	addi	a5,a5,440 # 7df8 <malloc+0x1e1a>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	1b478793          	addi	a5,a5,436 # 7e00 <malloc+0x1e22>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	1b078793          	addi	a5,a5,432 # 7e08 <malloc+0x1e2a>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	1ac78793          	addi	a5,a5,428 # 7e10 <malloc+0x1e32>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cd6:	0c650513          	addi	a0,a0,198 # 6d98 <malloc+0xdba>
    4cda:	00001097          	auipc	ra,0x1
    4cde:	24c080e7          	jalr	588(ra) # 5f26 <printf>
      exit(1);
    4ce2:	4505                	li	a0,1
    ...
    4d50:	0cc50513          	addi	a0,a0,204 # 7e18 <malloc+0x1e3a>
    4d54:	00001097          	auipc	ra,0x1
    4d58:	1d2080e7          	jalr	466(ra) # 5f26 <printf>
        exit(1);
    4d5c:	4505                	li	a0,1
    ...
    4d6a:	0c250513          	addi	a0,a0,194 # 7e28 <malloc+0x1e4a>
    4d6e:	00001097          	auipc	ra,0x1
    4d72:	1b8080e7          	jalr	440(ra) # 5f26 <printf>
          exit(1);
    4d76:	4505                	li	a0,1
    ...
    4d90:	0b450513          	addi	a0,a0,180 # 7e40 <malloc+0x1e62>
    4d94:	00001097          	auipc	ra,0x1
    4d98:	192080e7          	jalr	402(ra) # 5f26 <printf>
          exit(1);
    4d9c:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	03c50513          	addi	a0,a0,60 # 7e50 <malloc+0x1e72>
    4e1c:	00001097          	auipc	ra,0x1
    4e20:	10a080e7          	jalr	266(ra) # 5f26 <printf>
      exit(1);
    4e24:	4505                	li	a0,1
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e7a:	ff2b8b93          	addi	s7,s7,-14 # 7e68 <malloc+0x1e8a>
  for(i = 0; i < N; i++){
    ...
    4ebc:	fb850513          	addi	a0,a0,-72 # 7e70 <malloc+0x1e92>
    4ec0:	00001097          	auipc	ra,0x1
    4ec4:	066080e7          	jalr	102(ra) # 5f26 <printf>
        exit(1);
    4ec8:	4505                	li	a0,1
    ...
    4eda:	f9250513          	addi	a0,a0,-110 # 7e68 <malloc+0x1e8a>
  ...
  fd = open(".", 0);
    ...
    4f12:	8e250513          	addi	a0,a0,-1822 # 67f0 <malloc+0x812>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f8a:	f0a50513          	addi	a0,a0,-246 # 7e90 <malloc+0x1eb2>
    4f8e:	00001097          	auipc	ra,0x1
    4f92:	f98080e7          	jalr	-104(ra) # 5f26 <printf>
        exit(1);
    4f96:	4505                	li	a0,1
    ...
    4faa:	f0a50513          	addi	a0,a0,-246 # 7eb0 <malloc+0x1ed2>
    4fae:	00001097          	auipc	ra,0x1
    4fb2:	f78080e7          	jalr	-136(ra) # 5f26 <printf>
        exit(1);
    4fb6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4fe2:	efa50513          	addi	a0,a0,-262 # 7ed8 <malloc+0x1efa>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	f40080e7          	jalr	-192(ra) # 5f26 <printf>
    exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffe:	99650513          	addi	a0,a0,-1642 # 6990 <malloc+0x9b2>
    5002:	00001097          	auipc	ra,0x1
    5006:	f24080e7          	jalr	-220(ra) # 5f26 <printf>
      exit(1);
    500a:	4505                	li	a0,1
...
00000000000051a8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5230:	ce450513          	addi	a0,a0,-796 # 7f10 <malloc+0x1f32>
  ...
  for(i = 0; ; i++){
    ...
    5294:	c9050513          	addi	a0,a0,-880 # 7f20 <malloc+0x1f42>
    5298:	00001097          	auipc	ra,0x1
    529c:	c8e080e7          	jalr	-882(ra) # 5f26 <printf>
    exit(1);
    52a0:	4505                	li	a0,1
    ...
    52b0:	c9450513          	addi	a0,a0,-876 # 7f40 <malloc+0x1f62>
    52b4:	00001097          	auipc	ra,0x1
    52b8:	c72080e7          	jalr	-910(ra) # 5f26 <printf>
      exit(1);
    52bc:	4505                	li	a0,1
    ...
    52cc:	c9850513          	addi	a0,a0,-872 # 7f60 <malloc+0x1f82>
    52d0:	00001097          	auipc	ra,0x1
    52d4:	c56080e7          	jalr	-938(ra) # 5f26 <printf>
    exit(1);
    52d8:	4505                	li	a0,1
    ...
    52e8:	c9c50513          	addi	a0,a0,-868 # 7f80 <malloc+0x1fa2>
    52ec:	00001097          	auipc	ra,0x1
    52f0:	c3a080e7          	jalr	-966(ra) # 5f26 <printf>
      exit(1);
    52f4:	4505                	li	a0,1
    ...
    5304:	ca050513          	addi	a0,a0,-864 # 7fa0 <malloc+0x1fc2>
    5308:	00001097          	auipc	ra,0x1
    530c:	c1e080e7          	jalr	-994(ra) # 5f26 <printf>
      exit(1);
    5310:	4505                	li	a0,1
    ...
    5320:	c9c50513          	addi	a0,a0,-868 # 7fb8 <malloc+0x1fda>
    5324:	00001097          	auipc	ra,0x1
    5328:	c02080e7          	jalr	-1022(ra) # 5f26 <printf>
      exit(1);
    532c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    534e:	bc650513          	addi	a0,a0,-1082 # 7f10 <malloc+0x1f32>
    ...
    5372:	c6a50513          	addi	a0,a0,-918 # 7fd8 <malloc+0x1ffa>
    5376:	00001097          	auipc	ra,0x1
    537a:	bb0080e7          	jalr	-1104(ra) # 5f26 <printf>
    exit(1);
    537e:	4505                	li	a0,1
...
0000000000005388 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53a8:	c5450513          	addi	a0,a0,-940 # 7ff8 <malloc+0x201a>
    53ac:	00001097          	auipc	ra,0x1
    53b0:	b7a080e7          	jalr	-1158(ra) # 5f26 <printf>
  for(nfiles = 0; ; nfiles++){
    53b4:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53c8:	c44c8c93          	addi	s9,s9,-956 # 8008 <malloc+0x202a>
    name[0] = 'f';
    ...
    5416:	b14080e7          	jalr	-1260(ra) # 5f26 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5438:	be450513          	addi	a0,a0,-1052 # 8018 <malloc+0x203a>
    543c:	00001097          	auipc	ra,0x1
    5440:	aea080e7          	jalr	-1302(ra) # 5f26 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ae:	b8e50513          	addi	a0,a0,-1138 # 8038 <malloc+0x205a>
    54b2:	00001097          	auipc	ra,0x1
    54b6:	a74080e7          	jalr	-1420(ra) # 5f26 <printf>
}
    ...
    5504:	b2850513          	addi	a0,a0,-1240 # 8028 <malloc+0x204a>
    5508:	00001097          	auipc	ra,0x1
    550c:	a1e080e7          	jalr	-1506(ra) # 5f26 <printf>
    close(fd);
    5510:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5536:	b1e50513          	addi	a0,a0,-1250 # 8050 <malloc+0x2072>
    553a:	00001097          	auipc	ra,0x1
    553e:	9ec080e7          	jalr	-1556(ra) # 5f26 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5566:	b1650513          	addi	a0,a0,-1258 # 8078 <malloc+0x209a>
    556a:	00001097          	auipc	ra,0x1
    556e:	9bc080e7          	jalr	-1604(ra) # 5f26 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    558a:	ada50513          	addi	a0,a0,-1318 # 8060 <malloc+0x2082>
    558e:	00001097          	auipc	ra,0x1
    5592:	998080e7          	jalr	-1640(ra) # 5f26 <printf>
    exit(1);
    5596:	4505                	li	a0,1
    ...
    55b2:	ad250513          	addi	a0,a0,-1326 # 8080 <malloc+0x20a2>
    55b6:	00001097          	auipc	ra,0x1
    55ba:	970080e7          	jalr	-1680(ra) # 5f26 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5602:	a8a50513          	addi	a0,a0,-1398 # 8088 <malloc+0x20aa>
    5606:	00001097          	auipc	ra,0x1
    560a:	920080e7          	jalr	-1760(ra) # 5f26 <printf>
        return 1;
    560e:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    565c:	b2098993          	addi	s3,s3,-1248 # 6178 <malloc+0x19a>
      uint64 a = (uint64) sbrk(4096);
    ...
    568e:	a5650513          	addi	a0,a0,-1450 # 80e0 <malloc+0x2102>
    5692:	00001097          	auipc	ra,0x1
    5696:	894080e7          	jalr	-1900(ra) # 5f26 <printf>
        exit(1);
    569a:	4505                	li	a0,1
    ...
    56a8:	9fc50513          	addi	a0,a0,-1540 # 80a0 <malloc+0x20c2>
    56ac:	00001097          	auipc	ra,0x1
    56b0:	87a080e7          	jalr	-1926(ra) # 5f26 <printf>
    exit(1);
    56b4:	4505                	li	a0,1
    ...
    56c2:	a0250513          	addi	a0,a0,-1534 # 80c0 <malloc+0x20e2>
    56c6:	00001097          	auipc	ra,0x1
    56ca:	860080e7          	jalr	-1952(ra) # 5f26 <printf>
    exit(1);
    56ce:	4505                	li	a0,1
  ...
  while(1){
    ...
    5710:	9f450513          	addi	a0,a0,-1548 # 8100 <malloc+0x2122>
    5714:	00001097          	auipc	ra,0x1
    5718:	812080e7          	jalr	-2030(ra) # 5f26 <printf>
      exit(1);
    571c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5772:	9b2b8b93          	addi	s7,s7,-1614 # 8120 <malloc+0x2142>
    int free0 = countfree();
    int free1 = 0;
    ...
    578c:	9b0d0d13          	addi	s10,s10,-1616 # 8138 <malloc+0x215a>
          return 1;
        }
      }
    }
    ...
    5794:	9c8c8c93          	addi	s9,s9,-1592 # 8158 <malloc+0x217a>
    5798:	a839                	j	57b6 <drivetests+0x6a>
        printf("usertests slow tests starting\n");
    579a:	856a                	mv	a0,s10
    579c:	00000097          	auipc	ra,0x0
    57a0:	78a080e7          	jalr	1930(ra) # 5f26 <printf>
    ...
    57bc:	76e080e7          	jalr	1902(ra) # 5f26 <printf>
    int free0 = countfree();
    ...
    5804:	726080e7          	jalr	1830(ra) # 5f26 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    586c:	92058593          	addi	a1,a1,-1760 # 8188 <malloc+0x21aa>
  ...
  char *justone = 0;
    ...
    588a:	90a58593          	addi	a1,a1,-1782 # 8190 <malloc+0x21b2>
    ...
    58a0:	94458593          	addi	a1,a1,-1724 # 81e0 <malloc+0x2202>
  ...
  int continuous = 0;
    ...
    58cc:	8d050513          	addi	a0,a0,-1840 # 8198 <malloc+0x21ba>
    58d0:	00000097          	auipc	ra,0x0
    58d4:	656080e7          	jalr	1622(ra) # 5f26 <printf>
    exit(1);
    58d8:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58f2:	8da50513          	addi	a0,a0,-1830 # 81c8 <malloc+0x21ea>
    58f6:	00000097          	auipc	ra,0x0
    58fa:	630080e7          	jalr	1584(ra) # 5f26 <printf>
  exit(0);
    58fe:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c5e:	1101                	addi	sp,sp,-32
    5c60:	ec06                	sd	ra,24(sp)
    5c62:	e822                	sd	s0,16(sp)
    5c64:	1000                	addi	s0,sp,32
    5c66:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c6a:	4605                	li	a2,1
    5c6c:	fef40593          	addi	a1,s0,-17
    5c70:	00000097          	auipc	ra,0x0
    5c74:	f3e080e7          	jalr	-194(ra) # 5bae <write>
}
    5c78:	60e2                	ld	ra,24(sp)
    5c7a:	6442                	ld	s0,16(sp)
    5c7c:	6105                	addi	sp,sp,32
    5c7e:	8082                	ret

0000000000005c80 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5c80:	7139                	addi	sp,sp,-64
    5c82:	fc06                	sd	ra,56(sp)
    5c84:	f822                	sd	s0,48(sp)
    5c86:	f426                	sd	s1,40(sp)
    5c88:	f04a                	sd	s2,32(sp)
    5c8a:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    5c90:	c299                	beqz	a3,5c96 <printint+0x16>
    5c92:	0805c963          	bltz	a1,5d24 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5c96:	2581                	sext.w	a1,a1
  neg = 0;
    5c98:	4881                	li	a7,0
    5c9a:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5ca0:	2601                	sext.w	a2,a2
    5ca2:	00003517          	auipc	a0,0x3
    5ca6:	90650513          	addi	a0,a0,-1786 # 85a8 <digits>
    5caa:	883a                	mv	a6,a4
    5cac:	2705                	addiw	a4,a4,1
    5cae:	02c5f7bb          	remuw	a5,a1,a2
    5cb2:	1782                	slli	a5,a5,0x20
    5cb4:	9381                	srli	a5,a5,0x20
    5cb6:	97aa                	add	a5,a5,a0
    5cb8:	0007c783          	lbu	a5,0(a5)
    5cbc:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5cc0:	0005879b          	sext.w	a5,a1
    5cc4:	02c5d5bb          	divuw	a1,a1,a2
    5cc8:	0685                	addi	a3,a3,1
    5cca:	fec7f0e3          	bgeu	a5,a2,5caa <printint+0x2a>
  if(neg)
    5cce:	00088c63          	beqz	a7,5ce6 <printint+0x66>
    buf[i++] = '-';
    5cd2:	fd070793          	addi	a5,a4,-48
    5cd6:	00878733          	add	a4,a5,s0
    5cda:	02d00793          	li	a5,45
    5cde:	fef70823          	sb	a5,-16(a4)
    5ce2:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5ce6:	02e05863          	blez	a4,5d16 <printint+0x96>
    5cea:	fc040793          	addi	a5,s0,-64
    5cee:	00e78933          	add	s2,a5,a4
    5cf2:	fff78993          	addi	s3,a5,-1
    5cf6:	99ba                	add	s3,s3,a4
    5cf8:	377d                	addiw	a4,a4,-1
    5cfa:	1702                	slli	a4,a4,0x20
    5cfc:	9301                	srli	a4,a4,0x20
    5cfe:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d02:	fff94583          	lbu	a1,-1(s2)
    5d06:	8526                	mv	a0,s1
    5d08:	00000097          	auipc	ra,0x0
    5d0c:	f56080e7          	jalr	-170(ra) # 5c5e <putc>
  while(--i >= 0)
    5d10:	197d                	addi	s2,s2,-1
    5d12:	ff3918e3          	bne	s2,s3,5d02 <printint+0x82>
}
    5d16:	70e2                	ld	ra,56(sp)
    5d18:	7442                	ld	s0,48(sp)
    5d1a:	74a2                	ld	s1,40(sp)
    5d1c:	7902                	ld	s2,32(sp)
    5d1e:	69e2                	ld	s3,24(sp)
    ...
    5d28:	4885                	li	a7,1
    x = -xx;
    5d2a:	bf85                	j	5c9a <printint+0x1a>

0000000000005d2c <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
    ...
    5d32:	fc26                	sd	s1,56(sp)
    5d34:	f84a                	sd	s2,48(sp)
    5d36:	f44e                	sd	s3,40(sp)
    5d38:	f052                	sd	s4,32(sp)
    5d3a:	ec56                	sd	s5,24(sp)
    5d3c:	e85a                	sd	s6,16(sp)
    5d3e:	e45e                	sd	s7,8(sp)
    5d40:	e062                	sd	s8,0(sp)
    5d42:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5d44:	0005c903          	lbu	s2,0(a1)
    5d48:	18090c63          	beqz	s2,5ee0 <vprintf+0x1b4>
    5d4c:	8aaa                	mv	s5,a0
    5d4e:	8bb2                	mv	s7,a2
    5d50:	00158493          	addi	s1,a1,1
  state = 0;
    5d54:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5d56:	02500a13          	li	s4,37
    5d5a:	4b55                	li	s6,21
    5d5c:	a839                	j	5d7a <vprintf+0x4e>
        putc(fd, c);
    5d5e:	85ca                	mv	a1,s2
    5d60:	8556                	mv	a0,s5
    5d62:	00000097          	auipc	ra,0x0
    5d66:	efc080e7          	jalr	-260(ra) # 5c5e <putc>
    5d6a:	a019                	j	5d70 <vprintf+0x44>
    } else if(state == '%'){
    5d6c:	01498d63          	beq	s3,s4,5d86 <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
    5d70:	0485                	addi	s1,s1,1
    5d72:	fff4c903          	lbu	s2,-1(s1)
    5d76:	16090563          	beqz	s2,5ee0 <vprintf+0x1b4>
    if(state == 0){
    5d7a:	fe0999e3          	bnez	s3,5d6c <vprintf+0x40>
      if(c == '%'){
    5d7e:	ff4910e3          	bne	s2,s4,5d5e <vprintf+0x32>
        state = '%';
    5d82:	89d2                	mv	s3,s4
    5d84:	b7f5                	j	5d70 <vprintf+0x44>
      if(c == 'd'){
    5d86:	13490263          	beq	s2,s4,5eaa <vprintf+0x17e>
    5d8a:	f9d9079b          	addiw	a5,s2,-99
    5d8e:	0ff7f793          	zext.b	a5,a5
    5d92:	12fb6563          	bltu	s6,a5,5ebc <vprintf+0x190>
    5d96:	f9d9079b          	addiw	a5,s2,-99
    5d9a:	0ff7f713          	zext.b	a4,a5
    5d9e:	10eb6f63          	bltu	s6,a4,5ebc <vprintf+0x190>
    5da2:	00271793          	slli	a5,a4,0x2
    5da6:	00002717          	auipc	a4,0x2
    5daa:	7aa70713          	addi	a4,a4,1962 # 8550 <malloc+0x2572>
    5dae:	97ba                	add	a5,a5,a4
    5db0:	439c                	lw	a5,0(a5)
    5db2:	97ba                	add	a5,a5,a4
    5db4:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5db6:	008b8913          	addi	s2,s7,8
    5dba:	4685                	li	a3,1
    5dbc:	4629                	li	a2,10
    5dbe:	000ba583          	lw	a1,0(s7)
    5dc2:	8556                	mv	a0,s5
    5dc4:	00000097          	auipc	ra,0x0
    5dc8:	ebc080e7          	jalr	-324(ra) # 5c80 <printint>
    5dcc:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5dce:	4981                	li	s3,0
    5dd0:	b745                	j	5d70 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5dd2:	008b8913          	addi	s2,s7,8
    5dd6:	4681                	li	a3,0
    5dd8:	4629                	li	a2,10
    5dda:	000ba583          	lw	a1,0(s7)
    5dde:	8556                	mv	a0,s5
    5de0:	00000097          	auipc	ra,0x0
    5de4:	ea0080e7          	jalr	-352(ra) # 5c80 <printint>
    5de8:	8bca                	mv	s7,s2
      state = 0;
    5dea:	4981                	li	s3,0
    5dec:	b751                	j	5d70 <vprintf+0x44>
        printint(fd, va_arg(ap, int), 16, 0);
    5dee:	008b8913          	addi	s2,s7,8
    5df2:	4681                	li	a3,0
    5df4:	4641                	li	a2,16
    5df6:	000ba583          	lw	a1,0(s7)
    5dfa:	8556                	mv	a0,s5
    5dfc:	00000097          	auipc	ra,0x0
    5e00:	e84080e7          	jalr	-380(ra) # 5c80 <printint>
    5e04:	8bca                	mv	s7,s2
      state = 0;
    5e06:	4981                	li	s3,0
    5e08:	b7a5                	j	5d70 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    5e0a:	008b8c13          	addi	s8,s7,8
    5e0e:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5e12:	03000593          	li	a1,48
    5e16:	8556                	mv	a0,s5
    5e18:	00000097          	auipc	ra,0x0
    5e1c:	e46080e7          	jalr	-442(ra) # 5c5e <putc>
  putc(fd, 'x');
    5e20:	07800593          	li	a1,120
    5e24:	8556                	mv	a0,s5
    5e26:	00000097          	auipc	ra,0x0
    5e2a:	e38080e7          	jalr	-456(ra) # 5c5e <putc>
    5e2e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e30:	00002b97          	auipc	s7,0x2
    5e34:	778b8b93          	addi	s7,s7,1912 # 85a8 <digits>
    5e38:	03c9d793          	srli	a5,s3,0x3c
    5e3c:	97de                	add	a5,a5,s7
    5e3e:	0007c583          	lbu	a1,0(a5)
    5e42:	8556                	mv	a0,s5
    5e44:	00000097          	auipc	ra,0x0
    5e48:	e1a080e7          	jalr	-486(ra) # 5c5e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e4c:	0992                	slli	s3,s3,0x4
    5e4e:	397d                	addiw	s2,s2,-1
    5e50:	fe0914e3          	bnez	s2,5e38 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5e54:	8be2                	mv	s7,s8
      state = 0;
    5e56:	4981                	li	s3,0
    5e58:	bf21                	j	5d70 <vprintf+0x44>
        s = va_arg(ap, char*);
    5e5a:	008b8993          	addi	s3,s7,8
    5e5e:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5e62:	02090163          	beqz	s2,5e84 <vprintf+0x158>
        while(*s != 0){
    5e66:	00094583          	lbu	a1,0(s2)
    5e6a:	c9a5                	beqz	a1,5eda <vprintf+0x1ae>
          putc(fd, *s);
    5e6c:	8556                	mv	a0,s5
    5e6e:	00000097          	auipc	ra,0x0
    5e72:	df0080e7          	jalr	-528(ra) # 5c5e <putc>
          s++;
    5e76:	0905                	addi	s2,s2,1
        while(*s != 0){
    5e78:	00094583          	lbu	a1,0(s2)
    5e7c:	f9e5                	bnez	a1,5e6c <vprintf+0x140>
        s = va_arg(ap, char*);
    5e7e:	8bce                	mv	s7,s3
      state = 0;
    5e80:	4981                	li	s3,0
    5e82:	b5fd                	j	5d70 <vprintf+0x44>
          s = "(null)";
    5e84:	00002917          	auipc	s2,0x2
    5e88:	6c490913          	addi	s2,s2,1732 # 8548 <malloc+0x256a>
        while(*s != 0){
    5e8c:	02800593          	li	a1,40
    5e90:	bff1                	j	5e6c <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    5e92:	008b8913          	addi	s2,s7,8
    5e96:	000bc583          	lbu	a1,0(s7)
    5e9a:	8556                	mv	a0,s5
    5e9c:	00000097          	auipc	ra,0x0
    5ea0:	dc2080e7          	jalr	-574(ra) # 5c5e <putc>
    5ea4:	8bca                	mv	s7,s2
      state = 0;
    5ea6:	4981                	li	s3,0
    5ea8:	b5e1                	j	5d70 <vprintf+0x44>
        putc(fd, c);
    5eaa:	02500593          	li	a1,37
    5eae:	8556                	mv	a0,s5
    5eb0:	00000097          	auipc	ra,0x0
    5eb4:	dae080e7          	jalr	-594(ra) # 5c5e <putc>
      state = 0;
    5eb8:	4981                	li	s3,0
    5eba:	bd5d                	j	5d70 <vprintf+0x44>
        putc(fd, '%');
    5ebc:	02500593          	li	a1,37
    5ec0:	8556                	mv	a0,s5
    5ec2:	00000097          	auipc	ra,0x0
    5ec6:	d9c080e7          	jalr	-612(ra) # 5c5e <putc>
        putc(fd, c);
    5eca:	85ca                	mv	a1,s2
    5ecc:	8556                	mv	a0,s5
    5ece:	00000097          	auipc	ra,0x0
    5ed2:	d90080e7          	jalr	-624(ra) # 5c5e <putc>
      state = 0;
    5ed6:	4981                	li	s3,0
    5ed8:	bd61                	j	5d70 <vprintf+0x44>
        s = va_arg(ap, char*);
    5eda:	8bce                	mv	s7,s3
      state = 0;
    5edc:	4981                	li	s3,0
    5ede:	bd49                	j	5d70 <vprintf+0x44>
    }
  }
}
    5ee0:	60a6                	ld	ra,72(sp)
    5ee2:	6406                	ld	s0,64(sp)
    5ee4:	74e2                	ld	s1,56(sp)
    5ee6:	7942                	ld	s2,48(sp)
    5ee8:	79a2                	ld	s3,40(sp)
    5eea:	7a02                	ld	s4,32(sp)
    5eec:	6ae2                	ld	s5,24(sp)
    5eee:	6b42                	ld	s6,16(sp)
    5ef0:	6ba2                	ld	s7,8(sp)
    5ef2:	6c02                	ld	s8,0(sp)
    5ef4:	6161                	addi	sp,sp,80
    5ef6:	8082                	ret

0000000000005ef8 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5ef8:	715d                	addi	sp,sp,-80
    5efa:	ec06                	sd	ra,24(sp)
    5efc:	e822                	sd	s0,16(sp)
    5efe:	1000                	addi	s0,sp,32
    5f00:	e010                	sd	a2,0(s0)
    5f02:	e414                	sd	a3,8(s0)
    5f04:	e818                	sd	a4,16(s0)
    5f06:	ec1c                	sd	a5,24(s0)
    5f08:	03043023          	sd	a6,32(s0)
    5f0c:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f10:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f14:	8622                	mv	a2,s0
    5f16:	00000097          	auipc	ra,0x0
    5f1a:	e16080e7          	jalr	-490(ra) # 5d2c <vprintf>
}
    5f1e:	60e2                	ld	ra,24(sp)
    5f20:	6442                	ld	s0,16(sp)
    5f22:	6161                	addi	sp,sp,80
    5f24:	8082                	ret

0000000000005f26 <printf>:

void
printf(const char *fmt, ...)
{
    5f26:	711d                	addi	sp,sp,-96
    5f28:	ec06                	sd	ra,24(sp)
    5f2a:	e822                	sd	s0,16(sp)
    5f2c:	1000                	addi	s0,sp,32
    5f2e:	e40c                	sd	a1,8(s0)
    5f30:	e810                	sd	a2,16(s0)
    5f32:	ec14                	sd	a3,24(s0)
    5f34:	f018                	sd	a4,32(s0)
    5f36:	f41c                	sd	a5,40(s0)
    5f38:	03043823          	sd	a6,48(s0)
    5f3c:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f40:	00840613          	addi	a2,s0,8
    5f44:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f48:	85aa                	mv	a1,a0
    5f4a:	4505                	li	a0,1
    5f4c:	00000097          	auipc	ra,0x0
    5f50:	de0080e7          	jalr	-544(ra) # 5d2c <vprintf>
}
    5f54:	60e2                	ld	ra,24(sp)
    5f56:	6442                	ld	s0,16(sp)
    5f58:	6125                	addi	sp,sp,96
    5f5a:	8082                	ret

0000000000005f5c <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f5c:	1141                	addi	sp,sp,-16
    5f5e:	e422                	sd	s0,8(sp)
    5f60:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5f62:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f66:	00003797          	auipc	a5,0x3
    5f6a:	4ea7b783          	ld	a5,1258(a5) # 9450 <freep>
    5f6e:	a02d                	j	5f98 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5f70:	4618                	lw	a4,8(a2)
    5f72:	9f2d                	addw	a4,a4,a1
    5f74:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5f78:	6398                	ld	a4,0(a5)
    5f7a:	6310                	ld	a2,0(a4)
    5f7c:	a83d                	j	5fba <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5f7e:	ff852703          	lw	a4,-8(a0)
    5f82:	9f31                	addw	a4,a4,a2
    5f84:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5f86:	ff053683          	ld	a3,-16(a0)
    5f8a:	a091                	j	5fce <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5f8c:	6398                	ld	a4,0(a5)
    5f8e:	00e7e463          	bltu	a5,a4,5f96 <free+0x3a>
    5f92:	00e6ea63          	bltu	a3,a4,5fa6 <free+0x4a>
{
    5f96:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f98:	fed7fae3          	bgeu	a5,a3,5f8c <free+0x30>
    5f9c:	6398                	ld	a4,0(a5)
    5f9e:	00e6e463          	bltu	a3,a4,5fa6 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fa2:	fee7eae3          	bltu	a5,a4,5f96 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5fa6:	ff852583          	lw	a1,-8(a0)
    5faa:	6390                	ld	a2,0(a5)
    5fac:	02059813          	slli	a6,a1,0x20
    5fb0:	01c85713          	srli	a4,a6,0x1c
    5fb4:	9736                	add	a4,a4,a3
    5fb6:	fae60de3          	beq	a2,a4,5f70 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5fba:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5fbe:	4790                	lw	a2,8(a5)
    5fc0:	02061593          	slli	a1,a2,0x20
    5fc4:	01c5d713          	srli	a4,a1,0x1c
    5fc8:	973e                	add	a4,a4,a5
    5fca:	fae68ae3          	beq	a3,a4,5f7e <free+0x22>
    p->s.ptr = bp->s.ptr;
    5fce:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5fd0:	00003717          	auipc	a4,0x3
    5fd4:	48f73023          	sd	a5,1152(a4) # 9450 <freep>
}
    5fd8:	6422                	ld	s0,8(sp)
    5fda:	0141                	addi	sp,sp,16
    5fdc:	8082                	ret

0000000000005fde <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5fde:	7139                	addi	sp,sp,-64
    5fe0:	fc06                	sd	ra,56(sp)
    5fe2:	f822                	sd	s0,48(sp)
    5fe4:	f426                	sd	s1,40(sp)
    5fe6:	f04a                	sd	s2,32(sp)
    5fe8:	ec4e                	sd	s3,24(sp)
    5fea:	e852                	sd	s4,16(sp)
    5fec:	e456                	sd	s5,8(sp)
    5fee:	e05a                	sd	s6,0(sp)
    5ff0:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5ff2:	02051493          	slli	s1,a0,0x20
    5ff6:	9081                	srli	s1,s1,0x20
    5ff8:	04bd                	addi	s1,s1,15
    5ffa:	8091                	srli	s1,s1,0x4
    5ffc:	0014899b          	addiw	s3,s1,1
    6000:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    6002:	00003517          	auipc	a0,0x3
    6006:	44e53503          	ld	a0,1102(a0) # 9450 <freep>
    600a:	c515                	beqz	a0,6036 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    600c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    600e:	4798                	lw	a4,8(a5)
    6010:	02977f63          	bgeu	a4,s1,604e <malloc+0x70>
  if(nu < 4096)
    6014:	8a4e                	mv	s4,s3
    6016:	0009871b          	sext.w	a4,s3
    601a:	6685                	lui	a3,0x1
    601c:	00d77363          	bgeu	a4,a3,6022 <malloc+0x44>
    6020:	6a05                	lui	s4,0x1
    6022:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    6026:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    602a:	00003917          	auipc	s2,0x3
    602e:	42690913          	addi	s2,s2,1062 # 9450 <freep>
  if(p == (char*)-1)
    6032:	5afd                	li	s5,-1
    6034:	a895                	j	60a8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6036:	0000a797          	auipc	a5,0xa
    603a:	c4278793          	addi	a5,a5,-958 # fc78 <base>
    ...
    if(p->s.size >= nunits){
    604c:	b7e1                	j	6014 <malloc+0x36>
      if(p->s.size == nunits)
    604e:	02e48c63          	beq	s1,a4,6086 <malloc+0xa8>
        p->s.size -= nunits;
    6052:	4137073b          	subw	a4,a4,s3
    6056:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6058:	02071693          	slli	a3,a4,0x20
    605c:	01c6d713          	srli	a4,a3,0x1c
    6060:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    6062:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    6066:	00003717          	auipc	a4,0x3
    606a:	3ea73523          	sd	a0,1002(a4) # 9450 <freep>
      return (void*)(p + 1);
    606e:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    6072:	70e2                	ld	ra,56(sp)
    6074:	7442                	ld	s0,48(sp)
    6076:	74a2                	ld	s1,40(sp)
    6078:	7902                	ld	s2,32(sp)
    607a:	69e2                	ld	s3,24(sp)
    607c:	6a42                	ld	s4,16(sp)
    607e:	6aa2                	ld	s5,8(sp)
    6080:	6b02                	ld	s6,0(sp)
    6082:	6121                	addi	sp,sp,64
    6084:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    6086:	6398                	ld	a4,0(a5)
    6088:	e118                	sd	a4,0(a0)
    608a:	bff1                	j	6066 <malloc+0x88>
  hp->s.size = nu;
    608c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    6090:	0541                	addi	a0,a0,16
    6092:	00000097          	auipc	ra,0x0
    6096:	eca080e7          	jalr	-310(ra) # 5f5c <free>
  return freep;
    609a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    609e:	d971                	beqz	a0,6072 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60a0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60a2:	4798                	lw	a4,8(a5)
    60a4:	fa9775e3          	bgeu	a4,s1,604e <malloc+0x70>
    if(p == freep)
    60a8:	00093703          	ld	a4,0(s2)
    60ac:	853e                	mv	a0,a5
    60ae:	fef719e3          	bne	a4,a5,60a0 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    60b2:	8552                	mv	a0,s4
    60b4:	00000097          	auipc	ra,0x0
    60b8:	b62080e7          	jalr	-1182(ra) # 5c16 <sbrk>
  if(p == (char*)-1)
    60bc:	fd5518e3          	bne	a0,s5,608c <malloc+0xae>
        return 0;
    60c0:	4501                	li	a0,0
    60c2:	bf45                	j	6072 <malloc+0x94>
