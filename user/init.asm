...
printint(int fd, int xx, int base, int sgn)
{
 ...
 496:	50650513          	addi	a0,a0,1286 # 998 <digits>
 49a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 538:	18090c63          	beqz	s2,6d0 <vprintf+0x1b4>
 53c:	8aaa                	mv	s5,a0
 53e:	8bb2                	mv	s7,a2
 ...
 54a:	4b55                	li	s6,21
 54c:	a839                	j	56a <vprintf+0x4e>
        putc(fd, c);
 54e:	85ca                	mv	a1,s2
 550:	8556                	mv	a0,s5
 552:	00000097          	auipc	ra,0x0
 556:	efc080e7          	jalr	-260(ra) # 44e <putc>
 55a:	a019                	j	560 <vprintf+0x44>
    } else if(state == '%'){
 55c:	01498d63          	beq	s3,s4,576 <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
 560:	0485                	addi	s1,s1,1
 562:	fff4c903          	lbu	s2,-1(s1)
 566:	16090563          	beqz	s2,6d0 <vprintf+0x1b4>
    if(state == 0){
 56a:	fe0999e3          	bnez	s3,55c <vprintf+0x40>
      if(c == '%'){
 56e:	ff4910e3          	bne	s2,s4,54e <vprintf+0x32>
        state = '%';
 572:	89d2                	mv	s3,s4
 574:	b7f5                	j	560 <vprintf+0x44>
      if(c == 'd'){
 576:	13490263          	beq	s2,s4,69a <vprintf+0x17e>
 57a:	f9d9079b          	addiw	a5,s2,-99
 57e:	0ff7f793          	zext.b	a5,a5
 582:	12fb6563          	bltu	s6,a5,6ac <vprintf+0x190>
 586:	f9d9079b          	addiw	a5,s2,-99
 58a:	0ff7f713          	zext.b	a4,a5
 58e:	10eb6f63          	bltu	s6,a4,6ac <vprintf+0x190>
 592:	00271793          	slli	a5,a4,0x2
 596:	00000717          	auipc	a4,0x0
 59a:	3aa70713          	addi	a4,a4,938 # 940 <malloc+0x172>
 ...
 5b8:	ebc080e7          	jalr	-324(ra) # 470 <printint>
 5bc:	8bca                	mv	s7,s2
      } else {
 ...
 5d4:	ea0080e7          	jalr	-352(ra) # 470 <printint>
 5d8:	8bca                	mv	s7,s2
      state = 0;
 5da:	4981                	li	s3,0
 5dc:	b751                	j	560 <vprintf+0x44>
 ...
 5f0:	e84080e7          	jalr	-380(ra) # 470 <printint>
 5f4:	8bca                	mv	s7,s2
      state = 0;
 5f6:	4981                	li	s3,0
 5f8:	b7a5                	j	560 <vprintf+0x44>
 ...
 624:	378b8b93          	addi	s7,s7,888 # 998 <digits>
 ...
 644:	8be2                	mv	s7,s8
      state = 0;
 646:	4981                	li	s3,0
 648:	bf21                	j	560 <vprintf+0x44>
        s = va_arg(ap, char*);
 64a:	008b8993          	addi	s3,s7,8
 64e:	000bb903          	ld	s2,0(s7)
        if(s == 0)
 652:	02090163          	beqz	s2,674 <vprintf+0x158>
        while(*s != 0){
 656:	00094583          	lbu	a1,0(s2)
 65a:	c9a5                	beqz	a1,6ca <vprintf+0x1ae>
          putc(fd, *s);
 65c:	8556                	mv	a0,s5
 65e:	00000097          	auipc	ra,0x0
 662:	df0080e7          	jalr	-528(ra) # 44e <putc>
          s++;
 666:	0905                	addi	s2,s2,1
        while(*s != 0){
 668:	00094583          	lbu	a1,0(s2)
 66c:	f9e5                	bnez	a1,65c <vprintf+0x140>
        s = va_arg(ap, char*);
 66e:	8bce                	mv	s7,s3
      state = 0;
 670:	4981                	li	s3,0
 672:	b5fd                	j	560 <vprintf+0x44>
          s = "(null)";
 674:	00000917          	auipc	s2,0x0
 678:	2c490913          	addi	s2,s2,708 # 938 <malloc+0x16a>
        while(*s != 0){
 67c:	02800593          	li	a1,40
 680:	bff1                	j	65c <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
 682:	008b8913          	addi	s2,s7,8
 686:	000bc583          	lbu	a1,0(s7)
 68a:	8556                	mv	a0,s5
 68c:	00000097          	auipc	ra,0x0
 690:	dc2080e7          	jalr	-574(ra) # 44e <putc>
 694:	8bca                	mv	s7,s2
      state = 0;
 696:	4981                	li	s3,0
 698:	b5e1                	j	560 <vprintf+0x44>
        putc(fd, c);
 69a:	02500593          	li	a1,37
 69e:	8556                	mv	a0,s5
 6a0:	00000097          	auipc	ra,0x0
 6a4:	dae080e7          	jalr	-594(ra) # 44e <putc>
      state = 0;
 6a8:	4981                	li	s3,0
 6aa:	bd5d                	j	560 <vprintf+0x44>
        putc(fd, '%');
 6ac:	02500593          	li	a1,37
 6b0:	8556                	mv	a0,s5
 6b2:	00000097          	auipc	ra,0x0
 6b6:	d9c080e7          	jalr	-612(ra) # 44e <putc>
        putc(fd, c);
 6ba:	85ca                	mv	a1,s2
 6bc:	8556                	mv	a0,s5
 ...
 6c2:	d90080e7          	jalr	-624(ra) # 44e <putc>
      state = 0;
 6c6:	4981                	li	s3,0
 6c8:	bd61                	j	560 <vprintf+0x44>
        s = va_arg(ap, char*);
 6ca:	8bce                	mv	s7,s3
      state = 0;
 6cc:	4981                	li	s3,0
 6ce:	bd49                	j	560 <vprintf+0x44>
    }
  }
}
...
free(void *ap)
{
 ...
 75a:	8ba7b783          	ld	a5,-1862(a5) # 1010 <freep>
...
malloc(uint nbytes)
{
 ...
 85a:	7aa73d23          	sd	a0,1978(a4) # 1010 <freep>
      return (void*)(p + 1);
 ...
 8a8:	b62080e7          	jalr	-1182(ra) # 406 <sbrk>
  if(p == (char*)-1)
