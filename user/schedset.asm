...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	4a250513          	addi	a0,a0,1186 # 880 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e6:	34670713          	addi	a4,a4,838 # 828 <malloc+0x10e>
 ...
 5c4:	26090913          	addi	s2,s2,608 # 820 <malloc+0x106>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f4:	b62080e7          	jalr	-1182(ra) # 352 <sbrk>
  if(p == (char*)-1)
