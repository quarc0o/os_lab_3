...
main(int argc, char *argv[])
{
  ...
  40:	80458593          	addi	a1,a1,-2044 # 840 <malloc+0xf4>
  44:	4509                	li	a0,2
  46:	00000097          	auipc	ra,0x0
  4a:	620080e7          	jalr	1568(ra) # 666 <fprintf>
    exit(1);
  4e:	4505                	li	a0,1
  ...
  5e:	7fe58593          	addi	a1,a1,2046 # 858 <malloc+0x10c>
  62:	4509                	li	a0,2
  64:	00000097          	auipc	ra,0x0
  68:	602080e7          	jalr	1538(ra) # 666 <fprintf>
      break;
    }
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 414:	4c850513          	addi	a0,a0,1224 # 8d8 <digits>
 418:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 518:	36c70713          	addi	a4,a4,876 # 880 <malloc+0x134>
 ...
 5a2:	33ab8b93          	addi	s7,s7,826 # 8d8 <digits>
 ...
 5f6:	28690913          	addi	s2,s2,646 # 878 <malloc+0x12c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 826:	b62080e7          	jalr	-1182(ra) # 384 <sbrk>
  if(p == (char*)-1)
