...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 506:	33e70713          	addi	a4,a4,830 # 840 <malloc+0x106>
 ...
 590:	30cb8b93          	addi	s7,s7,780 # 898 <digits>
 ...
 5e4:	25890913          	addi	s2,s2,600 # 838 <malloc+0xfe>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 814:	b62080e7          	jalr	-1182(ra) # 372 <sbrk>
  if(p == (char*)-1)
